...
class PasswordAuthControllerLoginIntegrationTest extends ControllerIntegrationTestBase {
    ...
    class MultiDeviceLoginTest {
        ...
        void login_multipleDevices_issuesSeparateTokens() throws Exception {
            ...
            // when - 두 번 로그인
            LoginResult result1 = loginService.login(request, TEST_IP_ADDRESS, TEST_USER_AGENT);
            LoginResult result2 = loginService.login(request, TEST_IP_ADDRESS, TEST_USER_AGENT);
        ...
        void logout_oneDevice_otherDeviceTokensRemainValid() throws Exception {
            ...
            // 두 기기에서 로그인
            LoginResult deviceA = loginService.login(loginRequest, TEST_IP_ADDRESS, TEST_USER_AGENT);
            LoginResult deviceB = loginService.login(loginRequest, TEST_IP_ADDRESS, TEST_USER_AGENT);
