...
- **테스트 범위**: LKB-001 ~ LKB-093 (비즈니스 로직)

### 4.2 Controller 테스트
- **파일**: `backend/src/test/java/igrus/web/community/like/controller/LikeControllerTest.java`
- **파일**: `backend/src/test/java/igrus/web/community/bookmark/controller/BookmarkControllerTest.java`
- **테스트 범위**: LKB-001 ~ LKB-093 (HTTP 레이어)

### 4.3 통합 테스트
- **파일**: `backend/src/test/java/igrus/web/community/like/integration/LikeIntegrationTest.java`
- **파일**: `backend/src/test/java/igrus/web/community/bookmark/integration/BookmarkIntegrationTest.java`
