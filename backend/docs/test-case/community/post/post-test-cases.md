...
### 4.1 Service 테스트
- **파일**: `backend/src/test/java/igrus/web/community/post/service/PostServiceTest.java`
- **테스트 범위**: PST-001 ~ PST-092 (비즈니스 로직)

### 4.2 Controller 테스트
- **파일**: `backend/src/test/java/igrus/web/community/post/controller/PostControllerTest.java`
- **테스트 범위**: PST-001 ~ PST-092 (HTTP 레이어)

### 4.3 통합 테스트
- **파일**: `backend/src/test/java/igrus/web/community/post/integration/PostIntegrationTest.java`
