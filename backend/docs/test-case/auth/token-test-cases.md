...
| TKN-025 | 권한 변경 시 모든 토큰 무효화 | 관리자가 사용자 권한 변경 | 기존 Refresh Token 상태 확인 | 모든 기존 토큰 무효화, 재로그인 필요 | ✅ |
| TKN-026 | 준회원 승인 시 모든 토큰 무효화 | 관리자가 준회원을 정회원으로 승인 | 기존 Refresh Token 상태 확인 | 모든 기존 토큰 무효화, 재로그인 필요 | ✅ |
...
| FR-022a | 권한 변경/승인 시 모든 토큰 무효화 | TKN-025, TKN-026 |
...
| 1.5 | 2026-02-09 | Claude | 권한 변경/승인 시 토큰 무효화 테스트 케이스 추가 (TKN-025, TKN-026) - Issue #277 |
