...
- **테스트 범위**: INQ-D-001~005, INQ-D-010~017, INQ-D-029, INQ-D-031~033, INQ-D-040~043, INQ-D-050~051, INQ-D-060
- **테스트 수**: 12개
...
### 4.6 미구현 테스트
- canTransitionTo() 전체 매트릭스 (INQ-D-020~028): FSM 완전성 검증 필요 (GAP-INQ-01, GAP-INQ-05 해소)
- changeStatus() 무효 전이 (INQ-D-030): COMPLETED → 다른 상태 예외 검증
- 비밀번호 해시 저장 (INQ-D-006): 엔티티 레벨 검증
- 빈 리스트 검증 (INQ-D-045, INQ-D-063): 초기 상태 확인
- getAuthorUserId() Member (INQ-D-014): User ID 위임 검증
- 답변 getReply() (INQ-D-054): 설정 후 조회 검증
