...
- **테스트 범위**: INQ-A-001~002 (전체 목록, 유형 필터)
- **테스트 수**: 2개

### 4.2 서비스 통합 테스트 - 상태 변경
- **파일**: `backend/src/test/java/igrus/web/inquiry/service/manage/UpdateInquiryStatusServiceTest.java`
- **테스트 범위**: INQ-A-020 (PENDING → IN_PROGRESS)
- **테스트 수**: 1개

### 4.3 서비스 통합 테스트 - 답변
- **파일**: `backend/src/test/java/igrus/web/inquiry/service/manage/CreateInquiryReplyServiceTest.java`
- **테스트 범위**: INQ-A-040, INQ-A-044 (답변 작성 성공, 중복 답변)
- **테스트 수**: 2개

### 4.4 서비스 통합 테스트 - 메모
- **파일**: `backend/src/test/java/igrus/web/inquiry/service/manage/CreateInquiryMemoServiceTest.java`
- **테스트 범위**: INQ-A-060 (메모 작성 성공)
- **테스트 수**: 1개

### 4.5 서비스 통합 테스트 - 삭제
- **파일**: `backend/src/test/java/igrus/web/inquiry/service/manage/DeleteInquiryServiceTest.java`
- **테스트 범위**: INQ-A-070 (soft delete 성공)
- **테스트 수**: 1개

### 4.6 미구현 테스트
- 상태 필터 조회 (INQ-A-003~004): 서비스 통합 테스트 필요
- 문의 상세 조회 (INQ-A-010~014): GetInquiryDetailService 전용 테스트 없음
- COMPLETED 금지 전이 (INQ-A-025~026): GAP-INQ-01 해소 필요
- IN_PROGRESS 전이 (INQ-A-022~023): GAP-INQ-05 해소 필요
- 멱등성 전이 (INQ-A-024, 027~028): 서비스 통합 테스트 필요
- 답변 수정 (INQ-A-050~053): UpdateInquiryReplyService 테스트 필요
- 이메일 알림 영향 (INQ-A-047): GAP-INQ-06 해소 필요
- 삭제 감사 이력 (INQ-A-071): DB 레벨 검증 필요
- 컨트롤러 레벨 테스트: 전무 (GAP-INQ-04)
