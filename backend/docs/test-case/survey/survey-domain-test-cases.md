...
| 카테고리 | 전체 | ⬜ |
|---------|:---:|:---:|
| 설문 생성 (SRV-001~017) | 17 | 17 |
| 공개 상태 전이 (SRV-020~029) | 10 | 10 |
| 응답 수집 상태 전이 (SRV-030~038) | 9 | 9 |
| 비공개 전환 자동 마감 (SRV-040~042) | 3 | 3 |
| publishAndOpen (SRV-045~049) | 5 | 5 |
| 마감일 조건 (SRV-050~055) | 6 | 6 |
| 휴지통 행동 (SRV-060~081) | 22 | 22 |
| 설문 수정 (SRV-085~091) | 7 | 7 |
| 응답 수락 조건 (SRV-095~100) | 6 | 6 |
| 설문 복사 (SRV-105~117) | 13 | 13 |
| 질문 생성 (QST-001~011) | 11 | 11 |
| 질문 입력값 경계값 (QST-015~025) | 11 | 11 |
| 질문 필수 구성요소 (QST-030~038) | 9 | 9 |
| 선형 배율 범위 (QST-040~043) | 4 | 4 |
| 질문 수 제한 (QST-045~048) | 4 | 4 |
| 선택지/행 경계값 (QST-050~056) | 7 | 7 |
| Soft Delete (QST-060~065) | 6 | 6 |
| 질문 복사 (QST-070~076) | 7 | 7 |
| SurveyService CRUD (SVC-SRV-001~008) | 8 | 8 |
| SurveyService 상태 관리 (SVC-SRV-010~018) | 9 | 9 |
| SurveyService 휴지통 (SVC-SRV-020~026) | 7 | 7 |
| SurveyService 복사 (SVC-SRV-030~034) | 5 | 5 |
| SurveyService 응답 (SVC-SRV-040~051) | 12 | 12 |
| SurveyQuestionService (SVC-QST-001~012) | 12 | 12 |
| **합계** | **209** | **209** |
