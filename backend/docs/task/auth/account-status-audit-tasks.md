...
|-------|----------|------|--------|--------|
| Phase 1: 엔티티 & 마이그레이션 | 2 | 2 | 0 | 100% |
| Phase 2: 이벤트 기반 이력 저장 | 4 | 4 | 0 | 100% |
| Phase 3: Admin 조회 API | 4 | 4 | 0 | 100% |
| Phase 4: 테스트 | 3 | 3 | 0 | 100% |
...
- [x] **[T1]** `AccountStatusChangeHistory` 엔티티 생성
...
- [x] **[T3]** `AccountStatusChangeEvent` 도메인 이벤트 생성
...
- [x] **[T4]** `AccountStatusChangeHistoryRepository` 생성
...
- [x] **[T7]** `AccountStatusChangeHistoryResponse` DTO 생성
...
- [x] **[T8]** `GetAccountStatusChangeHistoryService` 서비스 생성
...
- [x] **[T9]** `AdminAccountStatusChangeHistoryController` 생성
...
- [x] **[T12]** `GetAccountStatusChangeHistoryServiceTest` 통합 테스트
  - 파일: `(test) user/service/GetAccountStatusChangeHistoryServiceTest.java`
  - `ServiceIntegrationTestBase` 확장
  - 테스트 케이스: 필터별 조회, 복합 필터, 페이지네이션, 빈 결과

- [x] **[T13]** `AdminAccountStatusChangeHistoryControllerTest` 통합 테스트
