...
4. **Given** 북마크한 게시글이 삭제되었을 때, **When** 북마크 목록을 조회하면, **Then** 해당 게시글은 "삭제된 게시글입니다"로 표시되고 클릭 불가 상태가 된다
...
2. **Given** 좋아요한 게시글이 삭제되었을 때, **When** 좋아요 목록을 조회하면, **Then** 해당 게시글은 "삭제된 게시글입니다"로 표시되고 클릭 불가 상태가 된다
...
- **FR-015**: 마이페이지 좋아요/북마크 목록은 페이지당 20개씩 무한 스크롤 방식으로 제공되어야 한다
...
- Q: 삭제된 게시글을 북마크/좋아요 목록에서 어떻게 처리해야 하나요? → A: 삭제된 게시글도 표시 (제목을 "삭제된 게시글입니다"로 대체, 클릭 불가)
- Q: 마이페이지 좋아요/북마크 목록의 페이지네이션 전략은? → A: 페이지당 20개씩, 무한 스크롤
