            ...
            <>
              ...
              <div className="relative">
                ...
                <select
                  ...
                  required
                  className={`w-full rounded-r4 pl-12 pr-4 py-s6 border focus:border-primary transition-all ${
                    isDark ? 'bg-white/5 border-border text-foreground' : 'bg-muted border-border text-foreground'
                  }`}
                >
              ...
              <div className="relative">
                ...
                <textarea
                  ...
                  required
                  rows={4}
                  className={`w-full rounded-r4 pl-12 pr-4 py-3 border focus:border-primary transition-all resize-none ${
                    isDark ? 'bg-white/5 border-border text-foreground placeholder:text-muted-foreground' : 'bg-muted border-border text-foreground placeholder:text-muted-foreground'
                  }`}
                />
              </div>
            </>
