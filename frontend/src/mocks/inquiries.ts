...
export const MOCK_INQUIRIES: Inquiry[] = [
  {
    ...
    answer: 'React Query의 기본 동작은 window focus 시 자동으로 refetch됩니다. refetchOnWindowFocus 옵션을 false로 설정해보세요.',
  },
  {
    id: '2',
  ...
  },
  {
    ...
    answer: '이벤트 페이지에서 해당 세미나를 클릭하시면 "참가 신청" 버튼이 있습니다. 로그인 후 이용 가능합니다.',
  },
  {
    id: '4',
  ...
  },
  {
    ...
    answer: 'Refresh Token을 사용하는 것을 추천합니다. axios interceptor에서 401 응답 시 refresh token으로 갱신 후 재요청하는 방식으로 구현하면 됩니다.',
  },
];
