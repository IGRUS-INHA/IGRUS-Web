...
export default function LoginPage() {
  ...
  const handleAccountRecovery = async (studentId: string) => {
    try {
      ...
      const eligibility =
        eligibilityResponse.data as unknown as RecoveryEligibilityResponse;
      ...
      const recoveryData =
        recoveryResponse.data as unknown as AccountRecoveryResponse;

      if (
        recoveryData.accessToken &&
        recoveryData.studentId &&
        recoveryData.name &&
        recoveryData.role
      ) {
        const user = {
  ...
  const handleLogin = async (data: { studentId: string; password: string }) => {
    setLoading(true);
    try {
