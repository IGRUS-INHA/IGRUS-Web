    ...
    <div className="py-8 max-w-4xl mx-auto">
      ...
      <div className="space-y-8">
        ...
        <section className="space-y-4">
          ...
          <ul className={cn('list-disc list-inside space-y-2 ml-4', isDark ? 'text-gray-400' : 'text-gray-600')}>
        ...
        <section className="space-y-4">
          ...
          <div className={cn('space-y-2', isDark ? 'text-gray-400' : 'text-gray-600')}>
        ...
        <section className="space-y-4">
          ...
          <div className={cn('mt-4 p-4 rounded-lg', isDark ? 'bg-gray-800/50' : 'bg-gray-100')}>
            <p className={cn('font-semibold mb-2', isDark ? 'text-white' : 'text-black')}>
              개인정보 보호책임자
            </p>
        ...
        <section className="space-y-4">
          ...
          <p className={cn('text-base leading-relaxed mt-2', isDark ? 'text-gray-400' : 'text-gray-600')}>
