    ...
    <div className="py-s6 max-w-4xl mx-auto">
      ...
      <div className="space-y-s6">
        ...
        <section className="space-y-s4">
          ...
          >
            IGRUS는 회원가입 및 서비스 제공을 위해 다음과 같은 개인정보를
            수집합니다:
          </p>
          <ul
            className={cn(
              "list-disc list-inside space-y-s2 ml-s4",
              isDark ? "text-gray-400" : "text-gray-600",
            )}
          >
        ...
        <section className="space-y-s4">
          ...
          >
            ...
            <li>서비스 제공: 게시판, 행사 관리, 문의 사항 처리 등</li>
            <li>마케팅 및 광고: 동아리 행사 안내, 공지사항 전달 등</li>
          </ul>
        </section>
        ...
        <section className="space-y-s4">
          ...
          >
            ...
            지체 없이 파기합니다. 단, 관련 법령에 의하여 보존할 필요가 있는 경우
        ...
        <section className="space-y-s4">
          ...
          >
            ...
            <p className="ml-s4">
              ...
              옮겨져 내부 방침 및 기타 관련 법령에 의한 정보보호 사유에 따라
              일정 기간 저장된 후 파기됩니다.
            </p>
        ...
        <section className="space-y-s4">
          ...
          >
            ...
            수 있으며, 가입 해지를 요청할 수도 있습니다. 개인정보의 조회/수정
            또는 가입해지를 하고자 할 경우에는 마이페이지를 통해 직접
            처리하거나, 개인정보 관리책임자에게 문의하시면 지체 없이
            조치하겠습니다.
          </p>
        </section>
        ...
        <section className="space-y-s4">
          ...
          >
            IGRUS는 개인정보 처리에 관한 업무를 총괄해서 책임지고, 개인정보
        ...
        <section className="space-y-s4">
          ...
          >
            ...
            7일 전부터 홈페이지의 공지사항을 통해 고지할 것입니다.
          </p>
          <p
            className={cn(
              "text-base leading-relaxed mt-s2",
              isDark ? "text-gray-400" : "text-gray-600",
            )}
          >
            본 방침은 {new Date().getFullYear()}년 {new Date().getMonth() + 1}월{" "}
