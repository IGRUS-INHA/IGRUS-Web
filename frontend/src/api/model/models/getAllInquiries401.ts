 ...
 */
import type { GetAllInquiries401InquiriesItem } from './getAllInquiries401InquiriesItem';

/**
 * 문의 목록 페이징 응답
 */
export type GetAllInquiries401 = {
  /** 문의 목록 */
  inquiries?: GetAllInquiries401InquiriesItem[];
  /** 전체 요소 수 */
