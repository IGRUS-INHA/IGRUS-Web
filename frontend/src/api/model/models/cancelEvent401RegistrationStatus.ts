...
export type CancelEvent401RegistrationStatus = typeof CancelEvent401RegistrationStatus[keyof typeof CancelEvent401RegistrationStatus];


export const CancelEvent401RegistrationStatus = {
