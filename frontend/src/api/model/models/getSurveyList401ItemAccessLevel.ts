...
export type GetSurveyList401ItemAccessLevel = typeof GetSurveyList401ItemAccessLevel[keyof typeof GetSurveyList401ItemAccessLevel];


export const GetSurveyList401ItemAccessLevel = {
  PUBLIC: 'PUBLIC',
  ASSOCIATE: 'ASSOCIATE',
  MEMBER: 'MEMBER',
  OPERATOR: 'OPERATOR',
