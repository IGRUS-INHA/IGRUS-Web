...
export type CreateSurvey401AccessLevel = typeof CreateSurvey401AccessLevel[keyof typeof CreateSurvey401AccessLevel];


export const CreateSurvey401AccessLevel = {
  PUBLIC: 'PUBLIC',
  ASSOCIATE: 'ASSOCIATE',
  MEMBER: 'MEMBER',
  OPERATOR: 'OPERATOR',
