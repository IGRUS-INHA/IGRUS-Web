 ...
 */
import type { GetLoginHistories403ContentItemFailureReason } from './getLoginHistories403ContentItemFailureReason';

/**
 * 로그인 이력 응답
 */
export type GetLoginHistories403ContentItem = {
  /** 로그인 이력 ID */
  id?: number;
  /** 사용자 ID (실패 시 null 가능) */
  userId?: number;
  ...
  success?: boolean;
  /** 실패 사유 (성공 시 null) */
  failureReason?: GetLoginHistories403ContentItemFailureReason;
  /** 로그인 시도 시각 */
  attemptedAt?: string;
};
