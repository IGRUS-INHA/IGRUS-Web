...
export type CreateSurvey201AccessLevel = typeof CreateSurvey201AccessLevel[keyof typeof CreateSurvey201AccessLevel];


export const CreateSurvey201AccessLevel = {
  PUBLIC: 'PUBLIC',
  ASSOCIATE: 'ASSOCIATE',
  MEMBER: 'MEMBER',
  OPERATOR: 'OPERATOR',
