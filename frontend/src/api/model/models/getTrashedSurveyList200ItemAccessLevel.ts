...
export type GetTrashedSurveyList200ItemAccessLevel = typeof GetTrashedSurveyList200ItemAccessLevel[keyof typeof GetTrashedSurveyList200ItemAccessLevel];


export const GetTrashedSurveyList200ItemAccessLevel = {
  PUBLIC: 'PUBLIC',
  ASSOCIATE: 'ASSOCIATE',
  MEMBER: 'MEMBER',
  OPERATOR: 'OPERATOR',
