 ...
 */
import type { GetAllInquiries200InquiriesItemStatus } from './getAllInquiries200InquiriesItemStatus';
import type { GetAllInquiries200InquiriesItemType } from './getAllInquiries200InquiriesItemType';

/**
 * 문의 목록 응답
 */
export type GetAllInquiries200InquiriesItem = {
  /** 문의 고유 ID */
  id?: number;
  /** 문의 번호 */
  inquiryNumber?: string;
  /** 문의 유형 */
  type?: GetAllInquiries200InquiriesItemType;
  /** 문의 유형 설명 */
  typeDescription?: string;
  /** 문의 상태 */
  status?: GetAllInquiries200InquiriesItemStatus;
  /** 문의 상태 설명 */
