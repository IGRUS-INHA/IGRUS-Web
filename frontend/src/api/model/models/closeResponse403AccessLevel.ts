...
export type CloseResponse403AccessLevel = typeof CloseResponse403AccessLevel[keyof typeof CloseResponse403AccessLevel];


export const CloseResponse403AccessLevel = {
  PUBLIC: 'PUBLIC',
  ASSOCIATE: 'ASSOCIATE',
  MEMBER: 'MEMBER',
  OPERATOR: 'OPERATOR',
