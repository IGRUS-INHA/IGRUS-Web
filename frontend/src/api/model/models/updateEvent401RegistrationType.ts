...
export type UpdateEvent401RegistrationType = typeof UpdateEvent401RegistrationType[keyof typeof UpdateEvent401RegistrationType];


export const UpdateEvent401RegistrationType = {
