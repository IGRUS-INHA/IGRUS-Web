...
export type GetSurveyDetail404AccessLevel = typeof GetSurveyDetail404AccessLevel[keyof typeof GetSurveyDetail404AccessLevel];


export const GetSurveyDetail404AccessLevel = {
  PUBLIC: 'PUBLIC',
  ASSOCIATE: 'ASSOCIATE',
  MEMBER: 'MEMBER',
  OPERATOR: 'OPERATOR',
