 ...
 */
import type { GetMyRegistrations200ItemStatus } from './getMyRegistrations200ItemStatus';

export type GetMyRegistrations200Item = {
  registrationId?: number;
  eventId?: number;
  eventTitle?: string;
  eventStartAt?: string;
  status?: GetMyRegistrations200ItemStatus;
  registeredAt?: string;
};
