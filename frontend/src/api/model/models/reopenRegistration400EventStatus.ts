...
export type ReopenRegistration400EventStatus = typeof ReopenRegistration400EventStatus[keyof typeof ReopenRegistration400EventStatus];


export const ReopenRegistration400EventStatus = {
  UPCOMING: 'UPCOMING',
  ONGOING: 'ONGOING',
  COMPLETED: 'COMPLETED',
  CANCELED: 'CANCELED',
