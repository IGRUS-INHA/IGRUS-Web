...
export type UpdateQuestion401AccessLevel = typeof UpdateQuestion401AccessLevel[keyof typeof UpdateQuestion401AccessLevel];


export const UpdateQuestion401AccessLevel = {
  PUBLIC: 'PUBLIC',
  ASSOCIATE: 'ASSOCIATE',
  MEMBER: 'MEMBER',
  OPERATOR: 'OPERATOR',
