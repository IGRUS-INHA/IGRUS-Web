...
export type EventDetailResponseRegistrationType = typeof EventDetailResponseRegistrationType[keyof typeof EventDetailResponseRegistrationType];


export const EventDetailResponseRegistrationType = {
