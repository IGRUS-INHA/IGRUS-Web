 ...
 */
import type { SignupBodyEnrollmentStatus } from './signupBodyEnrollmentStatus';
import type { SignupBodyGender } from './signupBodyGender';
import type { SignupBodyInterestsItem } from './signupBodyInterestsItem';
import type { SignupBodyJoinRoute } from './signupBodyJoinRoute';
import type { SignupBodyWishesItem } from './signupBodyWishesItem';
...
export type SignupBody = {
   ...
   * @maxItems 10
   */
  wishes?: SignupBodyWishesItem[];
  /**
   * 관심 분야 (최소 1개 선택)
   * @minItems 1
   * @maxItems 2147483647
   */
  interests: SignupBodyInterestsItem[];
  /**
  ...
  grade: number;
  /** 재학 상태 */
  enrollmentStatus: SignupBodyEnrollmentStatus;
  /** 개인정보 처리방침 동의 여부 */
