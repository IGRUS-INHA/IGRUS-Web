 ...
 */
import type { GetRegistrationList404ContentItemStatus } from './getRegistrationList404ContentItemStatus';

export type GetRegistrationList404ContentItem = {
  ...
  status?: GetRegistrationList404ContentItemStatus;
  registeredAt?: string;
};
