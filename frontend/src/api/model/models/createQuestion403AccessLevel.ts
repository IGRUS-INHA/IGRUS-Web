...
export type CreateQuestion403AccessLevel = typeof CreateQuestion403AccessLevel[keyof typeof CreateQuestion403AccessLevel];


export const CreateQuestion403AccessLevel = {
  PUBLIC: 'PUBLIC',
  ASSOCIATE: 'ASSOCIATE',
  MEMBER: 'MEMBER',
  OPERATOR: 'OPERATOR',
