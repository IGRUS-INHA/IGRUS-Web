 ...
 */
import type { GetRejectedAssociates401PageableSort } from './getRejectedAssociates401PageableSort';

export type GetRejectedAssociates401Pageable = {
  paged?: boolean;
  pageNumber?: number;
  pageSize?: number;
  offset?: number;
  sort?: GetRejectedAssociates401PageableSort;
  unpaged?: boolean;
};
