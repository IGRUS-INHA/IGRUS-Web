 ...
 */
import type { GetRegistrationList401ContentItemStatus } from './getRegistrationList401ContentItemStatus';

export type GetRegistrationList401ContentItem = {
  ...
  status?: GetRegistrationList401ContentItemStatus;
  registeredAt?: string;
};
