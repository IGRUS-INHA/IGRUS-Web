...
export type GetEventList401ItemEventStatus = typeof GetEventList401ItemEventStatus[keyof typeof GetEventList401ItemEventStatus];


export const GetEventList401ItemEventStatus = {
  UPCOMING: 'UPCOMING',
  ONGOING: 'ONGOING',
  COMPLETED: 'COMPLETED',
  CANCELED: 'CANCELED',
