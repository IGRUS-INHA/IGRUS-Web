 ...
 * 성별
 */
export type SignupWithTemporaryStudentIdBodyGender = typeof SignupWithTemporaryStudentIdBodyGender[keyof typeof SignupWithTemporaryStudentIdBodyGender];


export const SignupWithTemporaryStudentIdBodyGender = {
  MALE: 'MALE',
  FEMALE: 'FEMALE',
} as const;
