 ...
 * 재학 상태
 */
export type GetUserDetail401EnrollmentStatus = typeof GetUserDetail401EnrollmentStatus[keyof typeof GetUserDetail401EnrollmentStatus];


export const GetUserDetail401EnrollmentStatus = {
  ENROLLED: 'ENROLLED',
