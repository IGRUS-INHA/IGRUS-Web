...
export type GetEvent401RegistrationType = typeof GetEvent401RegistrationType[keyof typeof GetEvent401RegistrationType];


export const GetEvent401RegistrationType = {
