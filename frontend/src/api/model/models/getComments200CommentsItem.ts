 ...
 */
import type { GetComments200CommentsItemRepliesItem } from './getComments200CommentsItemRepliesItem';

export type GetComments200CommentsItem = {
  id?: number;
  postId?: number;
  content?: string;
  authorId?: number;
  ...
  likeCount?: number;
  createdAt?: string;
  replies?: GetComments200CommentsItemRepliesItem[];
  anonymous?: boolean;
  deleted?: boolean;
  likedByMe?: boolean;
};
