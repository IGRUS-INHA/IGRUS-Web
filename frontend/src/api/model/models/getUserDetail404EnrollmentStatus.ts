 ...
 * 재학 상태
 */
export type GetUserDetail404EnrollmentStatus = typeof GetUserDetail404EnrollmentStatus[keyof typeof GetUserDetail404EnrollmentStatus];


export const GetUserDetail404EnrollmentStatus = {
  ENROLLED: 'ENROLLED',
