...
export type ReopenRegistration200EventStatus = typeof ReopenRegistration200EventStatus[keyof typeof ReopenRegistration200EventStatus];


export const ReopenRegistration200EventStatus = {
  UPCOMING: 'UPCOMING',
  ONGOING: 'ONGOING',
  COMPLETED: 'COMPLETED',
  CANCELED: 'CANCELED',
