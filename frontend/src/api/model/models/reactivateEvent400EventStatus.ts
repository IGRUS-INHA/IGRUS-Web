...
export type ReactivateEvent400EventStatus = typeof ReactivateEvent400EventStatus[keyof typeof ReactivateEvent400EventStatus];


export const ReactivateEvent400EventStatus = {
  UPCOMING: 'UPCOMING',
  ONGOING: 'ONGOING',
  COMPLETED: 'COMPLETED',
  CANCELED: 'CANCELED',
