 ...
 * 문의 상태
 */
export type GetAllInquiries200InquiriesItemStatus = typeof GetAllInquiries200InquiriesItemStatus[keyof typeof GetAllInquiries200InquiriesItemStatus];


export const GetAllInquiries200InquiriesItemStatus = {
  PENDING: 'PENDING',
