...
export type PublishSurvey403AccessLevel = typeof PublishSurvey403AccessLevel[keyof typeof PublishSurvey403AccessLevel];


export const PublishSurvey403AccessLevel = {
  PUBLIC: 'PUBLIC',
  ASSOCIATE: 'ASSOCIATE',
  MEMBER: 'MEMBER',
  OPERATOR: 'OPERATOR',
