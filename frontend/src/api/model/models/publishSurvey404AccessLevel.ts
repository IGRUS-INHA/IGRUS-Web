...
export type PublishSurvey404AccessLevel = typeof PublishSurvey404AccessLevel[keyof typeof PublishSurvey404AccessLevel];


export const PublishSurvey404AccessLevel = {
  PUBLIC: 'PUBLIC',
  ASSOCIATE: 'ASSOCIATE',
  MEMBER: 'MEMBER',
  OPERATOR: 'OPERATOR',
