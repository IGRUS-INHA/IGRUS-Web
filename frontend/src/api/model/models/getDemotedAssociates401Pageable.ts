 ...
 */
import type { GetDemotedAssociates401PageableSort } from './getDemotedAssociates401PageableSort';

export type GetDemotedAssociates401Pageable = {
  paged?: boolean;
  pageNumber?: number;
  pageSize?: number;
  offset?: number;
  sort?: GetDemotedAssociates401PageableSort;
  unpaged?: boolean;
};
