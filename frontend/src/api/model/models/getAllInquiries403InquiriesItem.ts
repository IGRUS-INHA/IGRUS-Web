 ...
 */
import type { GetAllInquiries403InquiriesItemStatus } from './getAllInquiries403InquiriesItemStatus';
import type { GetAllInquiries403InquiriesItemType } from './getAllInquiries403InquiriesItemType';

/**
 * 문의 목록 응답
 */
export type GetAllInquiries403InquiriesItem = {
  /** 문의 고유 ID */
  id?: number;
  /** 문의 번호 */
  inquiryNumber?: string;
  /** 문의 유형 */
  type?: GetAllInquiries403InquiriesItemType;
  /** 문의 유형 설명 */
  typeDescription?: string;
  /** 문의 상태 */
  status?: GetAllInquiries403InquiriesItemStatus;
  /** 문의 상태 설명 */
