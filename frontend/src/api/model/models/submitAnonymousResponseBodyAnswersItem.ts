 ...
 */
import type { SubmitAnonymousResponseBodyAnswersItemGridAnswersItem } from './submitAnonymousResponseBodyAnswersItemGridAnswersItem';

export type SubmitAnonymousResponseBodyAnswersItem = {
  questionId: number;
  textValue?: string;
  selectedOptionIds?: number[];
  numericValue?: number;
  gridAnswers?: SubmitAnonymousResponseBodyAnswersItemGridAnswersItem[];
};
