 ...
 */
import type { GetUserList401UsersItemRole } from './getUserList401UsersItemRole';
import type { GetUserList401UsersItemStatus } from './getUserList401UsersItemStatus';

/**
 * 관리자용 회원 목록 응답
 */
export type GetUserList401UsersItem = {
  /** 사용자 ID */
  userId?: number;
  /** 학번 */
  studentId?: string;
  ...
  email?: string;
  /** 역할 */
  role?: GetUserList401UsersItemRole;
  /** 상태 */
  status?: GetUserList401UsersItemStatus;
  /** 가입일 */
  createdAt?: string;
};
