 ...
 */
import type { GetPendingAssociates200AssociatesItem } from './getPendingAssociates200AssociatesItem';

/**
 * 준회원 목록 페이징 응답
 */
export type GetPendingAssociates200 = {
  /** 준회원 목록 */
  associates?: GetPendingAssociates200AssociatesItem[];
  /** 전체 요소 수 */
