 ...
 * 현재 역할
 */
export type GetCandidateMembers400ItemRole = typeof GetCandidateMembers400ItemRole[keyof typeof GetCandidateMembers400ItemRole];


export const GetCandidateMembers400ItemRole = {
  ASSOCIATE: 'ASSOCIATE',
  MEMBER: 'MEMBER',
  OPERATOR: 'OPERATOR',
  ADMIN: 'ADMIN',
