...
export type ReopenRegistration403EventStatus = typeof ReopenRegistration403EventStatus[keyof typeof ReopenRegistration403EventStatus];


export const ReopenRegistration403EventStatus = {
  UPCOMING: 'UPCOMING',
  ONGOING: 'ONGOING',
  COMPLETED: 'COMPLETED',
  CANCELED: 'CANCELED',
