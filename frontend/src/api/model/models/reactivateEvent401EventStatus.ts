...
export type ReactivateEvent401EventStatus = typeof ReactivateEvent401EventStatus[keyof typeof ReactivateEvent401EventStatus];


export const ReactivateEvent401EventStatus = {
  UPCOMING: 'UPCOMING',
  ONGOING: 'ONGOING',
  COMPLETED: 'COMPLETED',
  CANCELED: 'CANCELED',
