 ...
 * 변경 후 역할
 */
export type GetRoleHistories200ContentItemNewRole = typeof GetRoleHistories200ContentItemNewRole[keyof typeof GetRoleHistories200ContentItemNewRole];


export const GetRoleHistories200ContentItemNewRole = {
  ASSOCIATE: 'ASSOCIATE',
  MEMBER: 'MEMBER',
  OPERATOR: 'OPERATOR',
  ADMIN: 'ADMIN',
