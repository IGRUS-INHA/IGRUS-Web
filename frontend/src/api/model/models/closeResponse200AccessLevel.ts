...
export type CloseResponse200AccessLevel = typeof CloseResponse200AccessLevel[keyof typeof CloseResponse200AccessLevel];


export const CloseResponse200AccessLevel = {
  PUBLIC: 'PUBLIC',
  ASSOCIATE: 'ASSOCIATE',
  MEMBER: 'MEMBER',
  OPERATOR: 'OPERATOR',
