 ...
 */
import type { UpdateMyResponseBodyAnswersItemGridAnswersItem } from './updateMyResponseBodyAnswersItemGridAnswersItem';

export type UpdateMyResponseBodyAnswersItem = {
  questionId: number;
  textValue?: string;
  selectedOptionIds?: number[];
  numericValue?: number;
  gridAnswers?: UpdateMyResponseBodyAnswersItemGridAnswersItem[];
};
