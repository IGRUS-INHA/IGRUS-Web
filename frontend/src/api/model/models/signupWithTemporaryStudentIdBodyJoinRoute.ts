 ...
 * 가입 경로
 */
export type SignupWithTemporaryStudentIdBodyJoinRoute = typeof SignupWithTemporaryStudentIdBodyJoinRoute[keyof typeof SignupWithTemporaryStudentIdBodyJoinRoute];


export const SignupWithTemporaryStudentIdBodyJoinRoute = {
  EVERYTIME: 'EVERYTIME',
  POSTER: 'POSTER',
  OT: 'OT',
  REFERRAL: 'REFERRAL',
