 ...
 */
import type { GetCandidateMembers400ItemRole } from './getCandidateMembers400ItemRole';
import type { GetCandidateMembers400ItemWishesItem } from './getCandidateMembers400ItemWishesItem';

/**
 * 학기별 회원 등록 후보 응답
 */
export type GetCandidateMembers400Item = {
  /** 사용자 ID */
  userId?: number;
  /** 학번 */
  studentId?: string;
  ...
  department?: string;
  /** 현재 역할 */
  role?: GetCandidateMembers400ItemRole;
  /** 해당 학기 등록 여부 */
  alreadyRegistered?: boolean;
  /** 가입 동기 */
  motivation?: string;
  /** 가입 목적 */
  wishes?: GetCandidateMembers400ItemWishesItem[];
};
