 ...
 */
import type { GetRoleHistories200ContentItemNewRole } from './getRoleHistories200ContentItemNewRole';
import type { GetRoleHistories200ContentItemPreviousRole } from './getRoleHistories200ContentItemPreviousRole';

/**
 * 권한 변경 이력 응답
 */
export type GetRoleHistories200ContentItem = {
  /** 이력 ID */
  id?: number;
  /** 대상 사용자 ID */
  userId?: number;
  ...
  studentId?: string;
  /** 변경 전 역할 */
  previousRole?: GetRoleHistories200ContentItemPreviousRole;
  /** 변경 후 역할 */
  newRole?: GetRoleHistories200ContentItemNewRole;
  /** 변경 사유 */
  reason?: string;
  /** 변경자 ID */
  changedBy?: number;
