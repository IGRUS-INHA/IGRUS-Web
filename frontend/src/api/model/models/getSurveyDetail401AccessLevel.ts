...
export type GetSurveyDetail401AccessLevel = typeof GetSurveyDetail401AccessLevel[keyof typeof GetSurveyDetail401AccessLevel];


export const GetSurveyDetail401AccessLevel = {
  PUBLIC: 'PUBLIC',
  ASSOCIATE: 'ASSOCIATE',
  MEMBER: 'MEMBER',
  OPERATOR: 'OPERATOR',
