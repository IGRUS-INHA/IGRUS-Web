 ...
 */
import type { GetRegistrationList401PageableSort } from './getRegistrationList401PageableSort';

export type GetRegistrationList401Pageable = {
  paged?: boolean;
  pageNumber?: number;
  pageSize?: number;
  offset?: number;
  sort?: GetRegistrationList401PageableSort;
  unpaged?: boolean;
};
