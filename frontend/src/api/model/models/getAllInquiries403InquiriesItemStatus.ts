 ...
 * 문의 상태
 */
export type GetAllInquiries403InquiriesItemStatus = typeof GetAllInquiries403InquiriesItemStatus[keyof typeof GetAllInquiries403InquiriesItemStatus];


export const GetAllInquiries403InquiriesItemStatus = {
  PENDING: 'PENDING',
