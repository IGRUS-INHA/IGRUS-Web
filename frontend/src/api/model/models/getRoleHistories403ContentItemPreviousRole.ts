 ...
 * 변경 전 역할
 */
export type GetRoleHistories403ContentItemPreviousRole = typeof GetRoleHistories403ContentItemPreviousRole[keyof typeof GetRoleHistories403ContentItemPreviousRole];


export const GetRoleHistories403ContentItemPreviousRole = {
  ASSOCIATE: 'ASSOCIATE',
  MEMBER: 'MEMBER',
  OPERATOR: 'OPERATOR',
  ADMIN: 'ADMIN',
