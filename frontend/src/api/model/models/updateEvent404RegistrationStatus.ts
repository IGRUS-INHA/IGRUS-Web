...
export type UpdateEvent404RegistrationStatus = typeof UpdateEvent404RegistrationStatus[keyof typeof UpdateEvent404RegistrationStatus];


export const UpdateEvent404RegistrationStatus = {
