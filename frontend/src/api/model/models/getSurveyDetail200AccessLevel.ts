...
export type GetSurveyDetail200AccessLevel = typeof GetSurveyDetail200AccessLevel[keyof typeof GetSurveyDetail200AccessLevel];


export const GetSurveyDetail200AccessLevel = {
  PUBLIC: 'PUBLIC',
  ASSOCIATE: 'ASSOCIATE',
  MEMBER: 'MEMBER',
  OPERATOR: 'OPERATOR',
