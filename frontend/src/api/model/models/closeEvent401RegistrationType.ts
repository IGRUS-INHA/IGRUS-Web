...
export type CloseEvent401RegistrationType = typeof CloseEvent401RegistrationType[keyof typeof CloseEvent401RegistrationType];


export const CloseEvent401RegistrationType = {
