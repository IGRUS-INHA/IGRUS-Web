...
export type RevertRegistration401Status = typeof RevertRegistration401Status[keyof typeof RevertRegistration401Status];


export const RevertRegistration401Status = {
