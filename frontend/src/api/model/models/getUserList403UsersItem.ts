 ...
 */
import type { GetUserList403UsersItemRole } from './getUserList403UsersItemRole';
import type { GetUserList403UsersItemStatus } from './getUserList403UsersItemStatus';

/**
 * 관리자용 회원 목록 응답
 */
export type GetUserList403UsersItem = {
  /** 사용자 ID */
  userId?: number;
  /** 학번 */
  studentId?: string;
  ...
  email?: string;
  /** 역할 */
  role?: GetUserList403UsersItemRole;
  /** 상태 */
  status?: GetUserList403UsersItemStatus;
  /** 가입일 */
  createdAt?: string;
};
