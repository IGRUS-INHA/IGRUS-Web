 ...
 * 문의 상태
 */
export type GetMyInquiries401InquiriesItemStatus = typeof GetMyInquiries401InquiriesItemStatus[keyof typeof GetMyInquiries401InquiriesItemStatus];


export const GetMyInquiries401InquiriesItemStatus = {
  PENDING: 'PENDING',
