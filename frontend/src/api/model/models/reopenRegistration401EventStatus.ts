...
export type ReopenRegistration401EventStatus = typeof ReopenRegistration401EventStatus[keyof typeof ReopenRegistration401EventStatus];


export const ReopenRegistration401EventStatus = {
  UPCOMING: 'UPCOMING',
  ONGOING: 'ONGOING',
  COMPLETED: 'COMPLETED',
  CANCELED: 'CANCELED',
