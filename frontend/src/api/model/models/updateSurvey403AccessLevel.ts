...
export type UpdateSurvey403AccessLevel = typeof UpdateSurvey403AccessLevel[keyof typeof UpdateSurvey403AccessLevel];


export const UpdateSurvey403AccessLevel = {
  PUBLIC: 'PUBLIC',
  ASSOCIATE: 'ASSOCIATE',
  MEMBER: 'MEMBER',
  OPERATOR: 'OPERATOR',
