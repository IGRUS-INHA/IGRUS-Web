 ...
 * 변경 후 역할
 */
export type GetRoleHistories401ContentItemNewRole = typeof GetRoleHistories401ContentItemNewRole[keyof typeof GetRoleHistories401ContentItemNewRole];


export const GetRoleHistories401ContentItemNewRole = {
  ASSOCIATE: 'ASSOCIATE',
  MEMBER: 'MEMBER',
  OPERATOR: 'OPERATOR',
  ADMIN: 'ADMIN',
