...
export type UpdateSurvey200AccessLevel = typeof UpdateSurvey200AccessLevel[keyof typeof UpdateSurvey200AccessLevel];


export const UpdateSurvey200AccessLevel = {
  PUBLIC: 'PUBLIC',
  ASSOCIATE: 'ASSOCIATE',
  MEMBER: 'MEMBER',
  OPERATOR: 'OPERATOR',
