 ...
 * 역할
 */
export type GetUserList401UsersItemRole = typeof GetUserList401UsersItemRole[keyof typeof GetUserList401UsersItemRole];


export const GetUserList401UsersItemRole = {
  ASSOCIATE: 'ASSOCIATE',
  MEMBER: 'MEMBER',
  OPERATOR: 'OPERATOR',
  ADMIN: 'ADMIN',
