 ...
 * 문의 유형
 */
export type GetMyInquiries200InquiriesItemType = typeof GetMyInquiries200InquiriesItemType[keyof typeof GetMyInquiries200InquiriesItemType];


export const GetMyInquiries200InquiriesItemType = {
  JOIN: 'JOIN',
  EVENT: 'EVENT',
  REPORT: 'REPORT',
  ACCOUNT: 'ACCOUNT',
