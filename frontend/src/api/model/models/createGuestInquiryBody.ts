 ...
 */
import type { CreateGuestInquiryBodyAttachmentsItem } from './createGuestInquiryBodyAttachmentsItem';
import type { CreateGuestInquiryBodyType } from './createGuestInquiryBodyType';

/**
 * 비회원 문의 생성 요청
 */
export type CreateGuestInquiryBody = {
  /** 문의 유형 */
  type: CreateGuestInquiryBodyType;
  /**
   * 문의 제목 (100자 이내)
   * @minLength 0
   * @maxLength 100
   ...
   * @maxItems 3
   */
  attachments?: CreateGuestInquiryBodyAttachmentsItem[];
};
