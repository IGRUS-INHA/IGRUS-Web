 ...
 */
import type { GetMyRegistrations401ItemStatus } from './getMyRegistrations401ItemStatus';

export type GetMyRegistrations401Item = {
  registrationId?: number;
  eventId?: number;
  eventTitle?: string;
  eventStartAt?: string;
  status?: GetMyRegistrations401ItemStatus;
  registeredAt?: string;
};
