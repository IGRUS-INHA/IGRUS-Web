 ...
 */
import type { SubmitAnonymousResponse201AnswersItem } from './submitAnonymousResponse201AnswersItem';

export type SubmitAnonymousResponse201 = {
  responseId?: number;
  surveyId?: number;
  userId?: number;
  answers?: SubmitAnonymousResponse201AnswersItem[];
  createdAt?: string;
};
