 ...
 * 변경 전 역할
 */
export type GetRoleHistories200ContentItemPreviousRole = typeof GetRoleHistories200ContentItemPreviousRole[keyof typeof GetRoleHistories200ContentItemPreviousRole];


export const GetRoleHistories200ContentItemPreviousRole = {
  ASSOCIATE: 'ASSOCIATE',
  MEMBER: 'MEMBER',
  OPERATOR: 'OPERATOR',
  ADMIN: 'ADMIN',
