...
export type EventDetailResponseEventStatus = typeof EventDetailResponseEventStatus[keyof typeof EventDetailResponseEventStatus];


export const EventDetailResponseEventStatus = {
  UPCOMING: 'UPCOMING',
  ONGOING: 'ONGOING',
  COMPLETED: 'COMPLETED',
  CANCELED: 'CANCELED',
