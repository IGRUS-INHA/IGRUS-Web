...
export type CreateQuestion201AccessLevel = typeof CreateQuestion201AccessLevel[keyof typeof CreateQuestion201AccessLevel];


export const CreateQuestion201AccessLevel = {
  PUBLIC: 'PUBLIC',
  ASSOCIATE: 'ASSOCIATE',
  MEMBER: 'MEMBER',
  OPERATOR: 'OPERATOR',
