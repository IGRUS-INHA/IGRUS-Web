 ...
 */
import type { GetDemotedAssociates200PageableSort } from './getDemotedAssociates200PageableSort';

export type GetDemotedAssociates200Pageable = {
  paged?: boolean;
  pageNumber?: number;
  pageSize?: number;
  offset?: number;
  sort?: GetDemotedAssociates200PageableSort;
  unpaged?: boolean;
};
