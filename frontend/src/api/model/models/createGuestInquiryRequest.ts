...
import type { CreateGuestInquiryRequestType } from "./createGuestInquiryRequestType";

/**
 * 비회원 문의 생성 요청
 */
export interface CreateGuestInquiryRequest {
  /** 문의 유형 */
  type: CreateGuestInquiryRequestType;
  /**
   * 문의 제목 (100자 이내)
   * @minLength 0
   * @maxLength 100
