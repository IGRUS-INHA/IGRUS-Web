...
export type UpdateQuestion404ResponseStatus = typeof UpdateQuestion404ResponseStatus[keyof typeof UpdateQuestion404ResponseStatus];


export const UpdateQuestion404ResponseStatus = {
