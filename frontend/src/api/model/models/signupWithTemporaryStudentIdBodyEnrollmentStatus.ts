 ...
 * 재학 상태
 */
export type SignupWithTemporaryStudentIdBodyEnrollmentStatus = typeof SignupWithTemporaryStudentIdBodyEnrollmentStatus[keyof typeof SignupWithTemporaryStudentIdBodyEnrollmentStatus];


export const SignupWithTemporaryStudentIdBodyEnrollmentStatus = {
  ENROLLED: 'ENROLLED',
