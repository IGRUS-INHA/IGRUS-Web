...
export type OpenResponse403AccessLevel = typeof OpenResponse403AccessLevel[keyof typeof OpenResponse403AccessLevel];


export const OpenResponse403AccessLevel = {
  PUBLIC: 'PUBLIC',
  ASSOCIATE: 'ASSOCIATE',
  MEMBER: 'MEMBER',
  OPERATOR: 'OPERATOR',
