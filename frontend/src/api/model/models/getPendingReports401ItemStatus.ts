...
export type GetPendingReports401ItemStatus = typeof GetPendingReports401ItemStatus[keyof typeof GetPendingReports401ItemStatus];


export const GetPendingReports401ItemStatus = {
  PENDING: 'PENDING',
  RESOLVED: 'RESOLVED',
  DISMISSED: 'DISMISSED',
} as const;
