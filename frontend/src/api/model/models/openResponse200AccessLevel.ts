...
export type OpenResponse200AccessLevel = typeof OpenResponse200AccessLevel[keyof typeof OpenResponse200AccessLevel];


export const OpenResponse200AccessLevel = {
  PUBLIC: 'PUBLIC',
  ASSOCIATE: 'ASSOCIATE',
  MEMBER: 'MEMBER',
  OPERATOR: 'OPERATOR',
