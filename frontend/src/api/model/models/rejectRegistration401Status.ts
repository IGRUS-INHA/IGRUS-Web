...
export type RejectRegistration401Status = typeof RejectRegistration401Status[keyof typeof RejectRegistration401Status];


export const RejectRegistration401Status = {
