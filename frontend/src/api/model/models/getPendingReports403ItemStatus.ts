...
export type GetPendingReports403ItemStatus = typeof GetPendingReports403ItemStatus[keyof typeof GetPendingReports403ItemStatus];


export const GetPendingReports403ItemStatus = {
  PENDING: 'PENDING',
  RESOLVED: 'RESOLVED',
  DISMISSED: 'DISMISSED',
} as const;
