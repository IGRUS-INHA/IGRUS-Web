 ...
 */
import type { GetRejectedAssociates403PageableSort } from './getRejectedAssociates403PageableSort';

export type GetRejectedAssociates403Pageable = {
  paged?: boolean;
  pageNumber?: number;
  pageSize?: number;
  offset?: number;
  sort?: GetRejectedAssociates403PageableSort;
  unpaged?: boolean;
};
