 ...
 */
import type { GetPendingAssociates401AssociatesItemWishesItem } from './getPendingAssociates401AssociatesItemWishesItem';

/**
 * 준회원(가입 승인 대기자) 정보 응답
 */
export type GetPendingAssociates401AssociatesItem = {
  /** 사용자 고유 ID */
  userId?: number;
  /** 학번 */
  studentId?: string;
  ...
  motivation?: string;
  /** 가입 목적 */
  wishes?: GetPendingAssociates401AssociatesItemWishesItem[];
  /** 가입 신청 일시 */
  createdAt?: string;
  /** 강등된 유저 여부 */
  demoted?: boolean;
