...
export type UpdateSurvey400AccessLevel = typeof UpdateSurvey400AccessLevel[keyof typeof UpdateSurvey400AccessLevel];


export const UpdateSurvey400AccessLevel = {
  PUBLIC: 'PUBLIC',
  ASSOCIATE: 'ASSOCIATE',
  MEMBER: 'MEMBER',
  OPERATOR: 'OPERATOR',
