 ...
 */
import type { GetPostViewHistory403ViewHistoryItem } from './getPostViewHistory403ViewHistoryItem';

/**
 * 게시글 조회 기록 페이징 응답
 */
export type GetPostViewHistory403 = {
  /** 조회 기록 목록 */
  viewHistory?: GetPostViewHistory403ViewHistoryItem[];
  /** 전체 요소 수 */
