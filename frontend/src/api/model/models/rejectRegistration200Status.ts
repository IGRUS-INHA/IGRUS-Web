...
export type RejectRegistration200Status = typeof RejectRegistration200Status[keyof typeof RejectRegistration200Status];


export const RejectRegistration200Status = {
