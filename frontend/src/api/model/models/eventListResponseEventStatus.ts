...
export type EventListResponseEventStatus = typeof EventListResponseEventStatus[keyof typeof EventListResponseEventStatus];


export const EventListResponseEventStatus = {
  UPCOMING: 'UPCOMING',
  ONGOING: 'ONGOING',
  COMPLETED: 'COMPLETED',
  CANCELED: 'CANCELED',
