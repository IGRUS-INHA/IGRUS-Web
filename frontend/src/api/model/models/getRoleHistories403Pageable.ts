 ...
 */
import type { GetRoleHistories403PageableSort } from './getRoleHistories403PageableSort';

export type GetRoleHistories403Pageable = {
  paged?: boolean;
  pageNumber?: number;
  pageSize?: number;
  offset?: number;
  sort?: GetRoleHistories403PageableSort;
  unpaged?: boolean;
};
