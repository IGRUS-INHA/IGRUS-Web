...
export type PublishAndOpen401ResponseStatus = typeof PublishAndOpen401ResponseStatus[keyof typeof PublishAndOpen401ResponseStatus];


export const PublishAndOpen401ResponseStatus = {
