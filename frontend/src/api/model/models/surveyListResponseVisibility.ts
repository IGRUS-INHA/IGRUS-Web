...
export type SurveyListResponseVisibility = typeof SurveyListResponseVisibility[keyof typeof SurveyListResponseVisibility];


export const SurveyListResponseVisibility = {
