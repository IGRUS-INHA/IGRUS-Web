 ...
 */
import type { GetMyRegistrations1401ItemStatus } from './getMyRegistrations1401ItemStatus';

export type GetMyRegistrations1401Item = {
  registrationId?: number;
  eventId?: number;
  eventTitle?: string;
  eventStartAt?: string;
  status?: GetMyRegistrations1401ItemStatus;
  registeredAt?: string;
};
