...
export type RevertRegistration200Status = typeof RevertRegistration200Status[keyof typeof RevertRegistration200Status];


export const RevertRegistration200Status = {
