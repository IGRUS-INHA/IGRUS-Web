 ...
 */
import type { CreateEventSurveyRequest } from "./createEventSurveyRequest";
import type { CreateEventWithSurveyRequestRegistrationType } from "./createEventWithSurveyRequestRegistrationType";

/**
 * 행사 + 설문 원자적 생성 요청. 행사와 설문(질문+선택지)을 하나의 트랜잭션으로 생성합니다.
 */
export interface CreateEventWithSurveyRequest {
  /**
   * @minLength 0
   * @maxLength 100
   */
  ...
  /** @minimum 1 */
  capacity: number;
  registrationType: CreateEventWithSurveyRequestRegistrationType;
  /**
  ...
  survey: CreateEventSurveyRequest;
}
