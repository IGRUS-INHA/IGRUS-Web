...
export type CreateEventWithSurveyRequestRegistrationType =
  (typeof CreateEventWithSurveyRequestRegistrationType)[keyof typeof CreateEventWithSurveyRequestRegistrationType];

export const CreateEventWithSurveyRequestRegistrationType = {
