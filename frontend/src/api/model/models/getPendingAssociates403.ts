 ...
 */
import type { GetPendingAssociates403AssociatesItem } from './getPendingAssociates403AssociatesItem';

/**
 * 준회원 목록 페이징 응답
 */
export type GetPendingAssociates403 = {
  /** 준회원 목록 */
  associates?: GetPendingAssociates403AssociatesItem[];
  /** 전체 요소 수 */
