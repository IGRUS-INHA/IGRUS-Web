...
export type CreateEventBodyRegistrationType = typeof CreateEventBodyRegistrationType[keyof typeof CreateEventBodyRegistrationType];


export const CreateEventBodyRegistrationType = {
