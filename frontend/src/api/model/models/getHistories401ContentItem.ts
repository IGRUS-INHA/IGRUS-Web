 ...
 */
import type { GetHistories401ContentItemChangeType } from './getHistories401ContentItemChangeType';

/**
 * 계정 상태 변경 감사 이력 응답
 */
export type GetHistories401ContentItem = {
  /** 이력 ID */
  id?: number;
  /** 대상 사용자 ID */
  userId?: number;
  ...
  /** 변경 유형 */
  changeType?: GetHistories401ContentItemChangeType;
  /** 변경 전 값 */
