...
export type CloseResponse404AccessLevel = typeof CloseResponse404AccessLevel[keyof typeof CloseResponse404AccessLevel];


export const CloseResponse404AccessLevel = {
  PUBLIC: 'PUBLIC',
  ASSOCIATE: 'ASSOCIATE',
  MEMBER: 'MEMBER',
  OPERATOR: 'OPERATOR',
