 ...
 * 현재 역할
 */
export type GetCandidateMembers401ItemRole = typeof GetCandidateMembers401ItemRole[keyof typeof GetCandidateMembers401ItemRole];


export const GetCandidateMembers401ItemRole = {
  ASSOCIATE: 'ASSOCIATE',
  MEMBER: 'MEMBER',
  OPERATOR: 'OPERATOR',
  ADMIN: 'ADMIN',
