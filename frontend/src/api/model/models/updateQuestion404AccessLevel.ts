...
export type UpdateQuestion404AccessLevel = typeof UpdateQuestion404AccessLevel[keyof typeof UpdateQuestion404AccessLevel];


export const UpdateQuestion404AccessLevel = {
  PUBLIC: 'PUBLIC',
  ASSOCIATE: 'ASSOCIATE',
  MEMBER: 'MEMBER',
  OPERATOR: 'OPERATOR',
