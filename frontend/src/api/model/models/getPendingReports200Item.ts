 ...
 */
import type { GetPendingReports200ItemStatus } from './getPendingReports200ItemStatus';

export type GetPendingReports200Item = {
  id?: number;
  commentId?: number;
  ...
  reporterName?: string;
  reason?: string;
  status?: GetPendingReports200ItemStatus;
  createdAt?: string;
  resolvedAt?: string;
  resolvedById?: number;
