...
export type UpdateQuestion200AccessLevel = typeof UpdateQuestion200AccessLevel[keyof typeof UpdateQuestion200AccessLevel];


export const UpdateQuestion200AccessLevel = {
  PUBLIC: 'PUBLIC',
  ASSOCIATE: 'ASSOCIATE',
  MEMBER: 'MEMBER',
  OPERATOR: 'OPERATOR',
