...
export type UpdateSurveyBodyAccessLevel = typeof UpdateSurveyBodyAccessLevel[keyof typeof UpdateSurveyBodyAccessLevel];


export const UpdateSurveyBodyAccessLevel = {
  PUBLIC: 'PUBLIC',
  ASSOCIATE: 'ASSOCIATE',
  MEMBER: 'MEMBER',
  OPERATOR: 'OPERATOR',
