 ...
 */
import type { SubmitAnonymousResponseBodyAnswersItem } from './submitAnonymousResponseBodyAnswersItem';

export type SubmitAnonymousResponseBody = {
  answers: SubmitAnonymousResponseBodyAnswersItem[];
};
