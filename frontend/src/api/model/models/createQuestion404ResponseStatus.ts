...
export type CreateQuestion404ResponseStatus = typeof CreateQuestion404ResponseStatus[keyof typeof CreateQuestion404ResponseStatus];


export const CreateQuestion404ResponseStatus = {
