 ...
 */
import type { GetRoleHistories401ContentItemNewRole } from './getRoleHistories401ContentItemNewRole';
import type { GetRoleHistories401ContentItemPreviousRole } from './getRoleHistories401ContentItemPreviousRole';

/**
 * 권한 변경 이력 응답
 */
export type GetRoleHistories401ContentItem = {
  /** 이력 ID */
  id?: number;
  /** 대상 사용자 ID */
  userId?: number;
  ...
  studentId?: string;
  /** 변경 전 역할 */
  previousRole?: GetRoleHistories401ContentItemPreviousRole;
  /** 변경 후 역할 */
  newRole?: GetRoleHistories401ContentItemNewRole;
  /** 변경 사유 */
  reason?: string;
  /** 변경자 ID */
  changedBy?: number;
