...
export type UpdateQuestion403AccessLevel = typeof UpdateQuestion403AccessLevel[keyof typeof UpdateQuestion403AccessLevel];


export const UpdateQuestion403AccessLevel = {
  PUBLIC: 'PUBLIC',
  ASSOCIATE: 'ASSOCIATE',
  MEMBER: 'MEMBER',
  OPERATOR: 'OPERATOR',
