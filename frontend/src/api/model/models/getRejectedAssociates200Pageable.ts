 ...
 */
import type { GetRejectedAssociates200PageableSort } from './getRejectedAssociates200PageableSort';

export type GetRejectedAssociates200Pageable = {
  paged?: boolean;
  pageNumber?: number;
  pageSize?: number;
  offset?: number;
  sort?: GetRejectedAssociates200PageableSort;
  unpaged?: boolean;
};
