...
export type CreateQuestion401AccessLevel = typeof CreateQuestion401AccessLevel[keyof typeof CreateQuestion401AccessLevel];


export const CreateQuestion401AccessLevel = {
  PUBLIC: 'PUBLIC',
  ASSOCIATE: 'ASSOCIATE',
  MEMBER: 'MEMBER',
  OPERATOR: 'OPERATOR',
