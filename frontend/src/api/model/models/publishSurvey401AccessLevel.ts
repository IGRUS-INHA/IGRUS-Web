...
export type PublishSurvey401AccessLevel = typeof PublishSurvey401AccessLevel[keyof typeof PublishSurvey401AccessLevel];


export const PublishSurvey401AccessLevel = {
  PUBLIC: 'PUBLIC',
  ASSOCIATE: 'ASSOCIATE',
  MEMBER: 'MEMBER',
  OPERATOR: 'OPERATOR',
