...
export type UpdateEvent404RegistrationType = typeof UpdateEvent404RegistrationType[keyof typeof UpdateEvent404RegistrationType];


export const UpdateEvent404RegistrationType = {
