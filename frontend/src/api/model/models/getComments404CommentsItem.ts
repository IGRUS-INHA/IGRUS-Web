 ...
 */
import type { GetComments404CommentsItemRepliesItem } from './getComments404CommentsItemRepliesItem';

export type GetComments404CommentsItem = {
  id?: number;
  postId?: number;
  content?: string;
  authorId?: number;
  ...
  likeCount?: number;
  createdAt?: string;
  replies?: GetComments404CommentsItemRepliesItem[];
  anonymous?: boolean;
  deleted?: boolean;
  likedByMe?: boolean;
};
