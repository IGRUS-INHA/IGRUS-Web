...
export type RejectRegistration403Status = typeof RejectRegistration403Status[keyof typeof RejectRegistration403Status];


export const RejectRegistration403Status = {
