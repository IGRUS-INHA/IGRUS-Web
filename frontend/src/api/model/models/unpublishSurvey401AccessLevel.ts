...
export type UnpublishSurvey401AccessLevel = typeof UnpublishSurvey401AccessLevel[keyof typeof UnpublishSurvey401AccessLevel];


export const UnpublishSurvey401AccessLevel = {
  PUBLIC: 'PUBLIC',
  ASSOCIATE: 'ASSOCIATE',
  MEMBER: 'MEMBER',
  OPERATOR: 'OPERATOR',
