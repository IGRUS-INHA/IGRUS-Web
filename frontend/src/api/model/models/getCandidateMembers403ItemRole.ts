 ...
 * 현재 역할
 */
export type GetCandidateMembers403ItemRole = typeof GetCandidateMembers403ItemRole[keyof typeof GetCandidateMembers403ItemRole];


export const GetCandidateMembers403ItemRole = {
  ASSOCIATE: 'ASSOCIATE',
  MEMBER: 'MEMBER',
  OPERATOR: 'OPERATOR',
  ADMIN: 'ADMIN',
