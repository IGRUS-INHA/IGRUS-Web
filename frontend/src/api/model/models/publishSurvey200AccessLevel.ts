...
export type PublishSurvey200AccessLevel = typeof PublishSurvey200AccessLevel[keyof typeof PublishSurvey200AccessLevel];


export const PublishSurvey200AccessLevel = {
  PUBLIC: 'PUBLIC',
  ASSOCIATE: 'ASSOCIATE',
  MEMBER: 'MEMBER',
  OPERATOR: 'OPERATOR',
