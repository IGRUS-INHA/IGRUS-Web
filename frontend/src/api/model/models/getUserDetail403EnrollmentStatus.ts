 ...
 * 재학 상태
 */
export type GetUserDetail403EnrollmentStatus = typeof GetUserDetail403EnrollmentStatus[keyof typeof GetUserDetail403EnrollmentStatus];


export const GetUserDetail403EnrollmentStatus = {
  ENROLLED: 'ENROLLED',
