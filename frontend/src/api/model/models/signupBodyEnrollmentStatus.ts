 ...
 * 재학 상태
 */
export type SignupBodyEnrollmentStatus = typeof SignupBodyEnrollmentStatus[keyof typeof SignupBodyEnrollmentStatus];


export const SignupBodyEnrollmentStatus = {
  ENROLLED: 'ENROLLED',
