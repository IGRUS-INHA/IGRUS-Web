...
export type CancelRegistration404Status = typeof CancelRegistration404Status[keyof typeof CancelRegistration404Status];


export const CancelRegistration404Status = {
