 ...
 */
import type { UpdateMyResponseBodyAnswersItem } from './updateMyResponseBodyAnswersItem';

export type UpdateMyResponseBody = {
  answers: UpdateMyResponseBodyAnswersItem[];
};
