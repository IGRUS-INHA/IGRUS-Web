 ...
 * 문의 유형
 */
export type GetAllInquiries401InquiriesItemType = typeof GetAllInquiries401InquiriesItemType[keyof typeof GetAllInquiries401InquiriesItemType];


export const GetAllInquiries401InquiriesItemType = {
  JOIN: 'JOIN',
  EVENT: 'EVENT',
  REPORT: 'REPORT',
  ACCOUNT: 'ACCOUNT',
