...
export type AdminEventListResponseEventStatus = typeof AdminEventListResponseEventStatus[keyof typeof AdminEventListResponseEventStatus];


export const AdminEventListResponseEventStatus = {
  UPCOMING: 'UPCOMING',
  ONGOING: 'ONGOING',
  COMPLETED: 'COMPLETED',
  CANCELED: 'CANCELED',
