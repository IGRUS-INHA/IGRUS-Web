 ...
 */
import type { GetMyInquiries401InquiriesItemStatus } from './getMyInquiries401InquiriesItemStatus';
import type { GetMyInquiries401InquiriesItemType } from './getMyInquiries401InquiriesItemType';

/**
 * 문의 목록 응답
 */
export type GetMyInquiries401InquiriesItem = {
  /** 문의 고유 ID */
  id?: number;
  /** 문의 번호 */
  inquiryNumber?: string;
  /** 문의 유형 */
  type?: GetMyInquiries401InquiriesItemType;
  /** 문의 유형 설명 */
  typeDescription?: string;
  /** 문의 상태 */
  status?: GetMyInquiries401InquiriesItemStatus;
  /** 문의 상태 설명 */
