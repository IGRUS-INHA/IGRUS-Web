...
export type PublishAndOpen404ResponseStatus = typeof PublishAndOpen404ResponseStatus[keyof typeof PublishAndOpen404ResponseStatus];


export const PublishAndOpen404ResponseStatus = {
