 ...
 */
import type { GetRegistrationList404PageableSort } from './getRegistrationList404PageableSort';

export type GetRegistrationList404Pageable = {
  paged?: boolean;
  pageNumber?: number;
  pageSize?: number;
  offset?: number;
  sort?: GetRegistrationList404PageableSort;
  unpaged?: boolean;
};
