...
export type OpenResponse401AccessLevel = typeof OpenResponse401AccessLevel[keyof typeof OpenResponse401AccessLevel];


export const OpenResponse401AccessLevel = {
  PUBLIC: 'PUBLIC',
  ASSOCIATE: 'ASSOCIATE',
  MEMBER: 'MEMBER',
  OPERATOR: 'OPERATOR',
