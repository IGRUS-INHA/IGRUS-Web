...
export type OpenResponse400AccessLevel = typeof OpenResponse400AccessLevel[keyof typeof OpenResponse400AccessLevel];


export const OpenResponse400AccessLevel = {
  PUBLIC: 'PUBLIC',
  ASSOCIATE: 'ASSOCIATE',
  MEMBER: 'MEMBER',
  OPERATOR: 'OPERATOR',
