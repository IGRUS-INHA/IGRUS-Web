 ...
 * 문의 상태
 */
export type LookupGuestInquiry401Status = typeof LookupGuestInquiry401Status[keyof typeof LookupGuestInquiry401Status];


export const LookupGuestInquiry401Status = {
  PENDING: 'PENDING',
