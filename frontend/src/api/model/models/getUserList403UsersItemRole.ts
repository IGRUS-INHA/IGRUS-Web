 ...
 * 역할
 */
export type GetUserList403UsersItemRole = typeof GetUserList403UsersItemRole[keyof typeof GetUserList403UsersItemRole];


export const GetUserList403UsersItemRole = {
  ASSOCIATE: 'ASSOCIATE',
  MEMBER: 'MEMBER',
  OPERATOR: 'OPERATOR',
  ADMIN: 'ADMIN',
