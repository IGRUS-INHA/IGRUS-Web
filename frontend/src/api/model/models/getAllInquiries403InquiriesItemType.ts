 ...
 * 문의 유형
 */
export type GetAllInquiries403InquiriesItemType = typeof GetAllInquiries403InquiriesItemType[keyof typeof GetAllInquiries403InquiriesItemType];


export const GetAllInquiries403InquiriesItemType = {
  JOIN: 'JOIN',
  EVENT: 'EVENT',
  REPORT: 'REPORT',
  ACCOUNT: 'ACCOUNT',
