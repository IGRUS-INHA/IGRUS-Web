 ...
 * 재학 상태
 */
export type GetUserDetail200EnrollmentStatus = typeof GetUserDetail200EnrollmentStatus[keyof typeof GetUserDetail200EnrollmentStatus];


export const GetUserDetail200EnrollmentStatus = {
  ENROLLED: 'ENROLLED',
