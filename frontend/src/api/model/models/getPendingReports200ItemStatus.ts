...
export type GetPendingReports200ItemStatus = typeof GetPendingReports200ItemStatus[keyof typeof GetPendingReports200ItemStatus];


export const GetPendingReports200ItemStatus = {
  PENDING: 'PENDING',
  RESOLVED: 'RESOLVED',
  DISMISSED: 'DISMISSED',
} as const;
