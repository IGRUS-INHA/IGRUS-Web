...
export type CreateQuestion400AccessLevel = typeof CreateQuestion400AccessLevel[keyof typeof CreateQuestion400AccessLevel];


export const CreateQuestion400AccessLevel = {
  PUBLIC: 'PUBLIC',
  ASSOCIATE: 'ASSOCIATE',
  MEMBER: 'MEMBER',
  OPERATOR: 'OPERATOR',
