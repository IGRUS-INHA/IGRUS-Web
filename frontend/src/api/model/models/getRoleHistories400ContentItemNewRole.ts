 ...
 * 변경 후 역할
 */
export type GetRoleHistories400ContentItemNewRole = typeof GetRoleHistories400ContentItemNewRole[keyof typeof GetRoleHistories400ContentItemNewRole];


export const GetRoleHistories400ContentItemNewRole = {
  ASSOCIATE: 'ASSOCIATE',
  MEMBER: 'MEMBER',
  OPERATOR: 'OPERATOR',
  ADMIN: 'ADMIN',
