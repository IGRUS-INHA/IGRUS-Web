 ...
 * 문의 유형
 */
export type GetAllInquiries200InquiriesItemType = typeof GetAllInquiries200InquiriesItemType[keyof typeof GetAllInquiries200InquiriesItemType];


export const GetAllInquiries200InquiriesItemType = {
  JOIN: 'JOIN',
  EVENT: 'EVENT',
  REPORT: 'REPORT',
  ACCOUNT: 'ACCOUNT',
