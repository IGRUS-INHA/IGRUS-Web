...
export type RevertRegistration404Status = typeof RevertRegistration404Status[keyof typeof RevertRegistration404Status];


export const RevertRegistration404Status = {
