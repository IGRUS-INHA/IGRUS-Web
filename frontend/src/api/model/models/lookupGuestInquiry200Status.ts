 ...
 * 문의 상태
 */
export type LookupGuestInquiry200Status = typeof LookupGuestInquiry200Status[keyof typeof LookupGuestInquiry200Status];


export const LookupGuestInquiry200Status = {
  PENDING: 'PENDING',
