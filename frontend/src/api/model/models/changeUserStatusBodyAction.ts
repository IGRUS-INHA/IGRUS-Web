 ...
 * 수행할 행위
 */
export type ChangeUserStatusBodyAction = typeof ChangeUserStatusBodyAction[keyof typeof ChangeUserStatusBodyAction];


export const ChangeUserStatusBodyAction = {
  SUSPEND: 'SUSPEND',
  LIFT: 'LIFT',
} as const;
