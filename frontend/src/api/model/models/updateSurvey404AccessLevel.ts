...
export type UpdateSurvey404AccessLevel = typeof UpdateSurvey404AccessLevel[keyof typeof UpdateSurvey404AccessLevel];


export const UpdateSurvey404AccessLevel = {
  PUBLIC: 'PUBLIC',
  ASSOCIATE: 'ASSOCIATE',
  MEMBER: 'MEMBER',
  OPERATOR: 'OPERATOR',
