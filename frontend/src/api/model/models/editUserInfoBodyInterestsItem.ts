...
export type EditUserInfoBodyInterestsItem = typeof EditUserInfoBodyInterestsItem[keyof typeof EditUserInfoBodyInterestsItem];


export const EditUserInfoBodyInterestsItem = {
