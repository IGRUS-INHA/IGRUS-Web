...
export type UnpublishSurvey403AccessLevel = typeof UnpublishSurvey403AccessLevel[keyof typeof UnpublishSurvey403AccessLevel];


export const UnpublishSurvey403AccessLevel = {
  PUBLIC: 'PUBLIC',
  ASSOCIATE: 'ASSOCIATE',
  MEMBER: 'MEMBER',
  OPERATOR: 'OPERATOR',
