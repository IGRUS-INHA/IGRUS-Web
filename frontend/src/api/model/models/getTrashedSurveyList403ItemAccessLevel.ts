...
export type GetTrashedSurveyList403ItemAccessLevel = typeof GetTrashedSurveyList403ItemAccessLevel[keyof typeof GetTrashedSurveyList403ItemAccessLevel];


export const GetTrashedSurveyList403ItemAccessLevel = {
  PUBLIC: 'PUBLIC',
  ASSOCIATE: 'ASSOCIATE',
  MEMBER: 'MEMBER',
  OPERATOR: 'OPERATOR',
