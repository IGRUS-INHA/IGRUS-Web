 ...
 * 변경 유형
 */
export type GetHistories401ContentItemChangeType = typeof GetHistories401ContentItemChangeType[keyof typeof GetHistories401ContentItemChangeType];


export const GetHistories401ContentItemChangeType = {
