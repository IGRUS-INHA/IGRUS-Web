...
export type ApproveRegistration404Status = typeof ApproveRegistration404Status[keyof typeof ApproveRegistration404Status];


export const ApproveRegistration404Status = {
