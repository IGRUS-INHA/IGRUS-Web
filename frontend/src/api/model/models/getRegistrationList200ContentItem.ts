 ...
 */
import type { GetRegistrationList200ContentItemStatus } from './getRegistrationList200ContentItemStatus';

export type GetRegistrationList200ContentItem = {
  ...
  status?: GetRegistrationList200ContentItemStatus;
  registeredAt?: string;
};
