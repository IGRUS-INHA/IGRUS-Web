 ...
 */
import type { GetUserList200UsersItemRole } from './getUserList200UsersItemRole';
import type { GetUserList200UsersItemStatus } from './getUserList200UsersItemStatus';

/**
 * 관리자용 회원 목록 응답
 */
export type GetUserList200UsersItem = {
  /** 사용자 ID */
  userId?: number;
  /** 학번 */
  studentId?: string;
  ...
  email?: string;
  /** 역할 */
  role?: GetUserList200UsersItemRole;
  /** 상태 */
  status?: GetUserList200UsersItemStatus;
  /** 가입일 */
  createdAt?: string;
};
