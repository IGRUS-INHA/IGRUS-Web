...
export type AnswerResponseQuestionType = typeof AnswerResponseQuestionType[keyof typeof AnswerResponseQuestionType];


export const AnswerResponseQuestionType = {
