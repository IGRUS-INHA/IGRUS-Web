...
export type CloseResponse401AccessLevel = typeof CloseResponse401AccessLevel[keyof typeof CloseResponse401AccessLevel];


export const CloseResponse401AccessLevel = {
  PUBLIC: 'PUBLIC',
  ASSOCIATE: 'ASSOCIATE',
  MEMBER: 'MEMBER',
  OPERATOR: 'OPERATOR',
