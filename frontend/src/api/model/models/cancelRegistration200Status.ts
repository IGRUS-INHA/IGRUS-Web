...
export type CancelRegistration200Status = typeof CancelRegistration200Status[keyof typeof CancelRegistration200Status];


export const CancelRegistration200Status = {
