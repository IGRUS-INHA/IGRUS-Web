...
export type ReactivateEvent400CloseReason = typeof ReactivateEvent400CloseReason[keyof typeof ReactivateEvent400CloseReason];


export const ReactivateEvent400CloseReason = {
