 ...
 */
import type { GetAllInquiries403InquiriesItem } from './getAllInquiries403InquiriesItem';

/**
 * 문의 목록 페이징 응답
 */
export type GetAllInquiries403 = {
  /** 문의 목록 */
  inquiries?: GetAllInquiries403InquiriesItem[];
  /** 전체 요소 수 */
