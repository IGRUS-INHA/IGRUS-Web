 ...
 * 질문 유형
 */
export type CreateEventSurveyQuestionRequestQuestionType =
  (typeof CreateEventSurveyQuestionRequestQuestionType)[keyof typeof CreateEventSurveyQuestionRequestQuestionType];

export const CreateEventSurveyQuestionRequestQuestionType = {
