 ...
 * 변경 후 역할
 */
export type GetRoleHistories403ContentItemNewRole = typeof GetRoleHistories403ContentItemNewRole[keyof typeof GetRoleHistories403ContentItemNewRole];


export const GetRoleHistories403ContentItemNewRole = {
  ASSOCIATE: 'ASSOCIATE',
  MEMBER: 'MEMBER',
  OPERATOR: 'OPERATOR',
  ADMIN: 'ADMIN',
