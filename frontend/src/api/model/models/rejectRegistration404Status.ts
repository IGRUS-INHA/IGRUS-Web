...
export type RejectRegistration404Status = typeof RejectRegistration404Status[keyof typeof RejectRegistration404Status];


export const RejectRegistration404Status = {
