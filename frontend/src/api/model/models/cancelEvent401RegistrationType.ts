...
export type CancelEvent401RegistrationType = typeof CancelEvent401RegistrationType[keyof typeof CancelEvent401RegistrationType];


export const CancelEvent401RegistrationType = {
