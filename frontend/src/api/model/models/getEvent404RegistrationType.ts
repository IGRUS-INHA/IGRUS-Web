...
export type GetEvent404RegistrationType = typeof GetEvent404RegistrationType[keyof typeof GetEvent404RegistrationType];


export const GetEvent404RegistrationType = {
