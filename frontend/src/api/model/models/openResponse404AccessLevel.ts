...
export type OpenResponse404AccessLevel = typeof OpenResponse404AccessLevel[keyof typeof OpenResponse404AccessLevel];


export const OpenResponse404AccessLevel = {
  PUBLIC: 'PUBLIC',
  ASSOCIATE: 'ASSOCIATE',
  MEMBER: 'MEMBER',
  OPERATOR: 'OPERATOR',
