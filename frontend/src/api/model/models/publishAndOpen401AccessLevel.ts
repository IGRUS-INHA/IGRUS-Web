...
export type PublishAndOpen401AccessLevel = typeof PublishAndOpen401AccessLevel[keyof typeof PublishAndOpen401AccessLevel];


export const PublishAndOpen401AccessLevel = {
  PUBLIC: 'PUBLIC',
  ASSOCIATE: 'ASSOCIATE',
  MEMBER: 'MEMBER',
  OPERATOR: 'OPERATOR',
