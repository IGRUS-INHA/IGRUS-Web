 ...
 * 문의 상태
 */
export type GetMyInquiries200InquiriesItemStatus = typeof GetMyInquiries200InquiriesItemStatus[keyof typeof GetMyInquiries200InquiriesItemStatus];


export const GetMyInquiries200InquiriesItemStatus = {
  PENDING: 'PENDING',
