...
export type GetAdminEventListEventStatus = typeof GetAdminEventListEventStatus[keyof typeof GetAdminEventListEventStatus];


export const GetAdminEventListEventStatus = {
  UPCOMING: 'UPCOMING',
  ONGOING: 'ONGOING',
  COMPLETED: 'COMPLETED',
  CANCELED: 'CANCELED',
