 ...
 * 문의 상태
 */
export type GetAllInquiries401InquiriesItemStatus = typeof GetAllInquiries401InquiriesItemStatus[keyof typeof GetAllInquiries401InquiriesItemStatus];


export const GetAllInquiries401InquiriesItemStatus = {
  PENDING: 'PENDING',
