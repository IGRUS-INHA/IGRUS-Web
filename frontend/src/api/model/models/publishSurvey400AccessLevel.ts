...
export type PublishSurvey400AccessLevel = typeof PublishSurvey400AccessLevel[keyof typeof PublishSurvey400AccessLevel];


export const PublishSurvey400AccessLevel = {
  PUBLIC: 'PUBLIC',
  ASSOCIATE: 'ASSOCIATE',
  MEMBER: 'MEMBER',
  OPERATOR: 'OPERATOR',
