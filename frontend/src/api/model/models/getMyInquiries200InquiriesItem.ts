 ...
 */
import type { GetMyInquiries200InquiriesItemStatus } from './getMyInquiries200InquiriesItemStatus';
import type { GetMyInquiries200InquiriesItemType } from './getMyInquiries200InquiriesItemType';

/**
 * 문의 목록 응답
 */
export type GetMyInquiries200InquiriesItem = {
  /** 문의 고유 ID */
  id?: number;
  /** 문의 번호 */
  inquiryNumber?: string;
  /** 문의 유형 */
  type?: GetMyInquiries200InquiriesItemType;
  /** 문의 유형 설명 */
  typeDescription?: string;
  /** 문의 상태 */
  status?: GetMyInquiries200InquiriesItemStatus;
  /** 문의 상태 설명 */
