 ...
 */
import type { SubmitAnonymousResponse403AnswersItem } from './submitAnonymousResponse403AnswersItem';

export type SubmitAnonymousResponse403 = {
  responseId?: number;
  surveyId?: number;
  userId?: number;
  answers?: SubmitAnonymousResponse403AnswersItem[];
  createdAt?: string;
};
