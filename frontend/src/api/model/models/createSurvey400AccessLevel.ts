...
export type CreateSurvey400AccessLevel = typeof CreateSurvey400AccessLevel[keyof typeof CreateSurvey400AccessLevel];


export const CreateSurvey400AccessLevel = {
  PUBLIC: 'PUBLIC',
  ASSOCIATE: 'ASSOCIATE',
  MEMBER: 'MEMBER',
  OPERATOR: 'OPERATOR',
