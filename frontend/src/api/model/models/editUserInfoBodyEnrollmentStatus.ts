 ...
 */
export type EditUserInfoBodyEnrollmentStatus = typeof EditUserInfoBodyEnrollmentStatus[keyof typeof EditUserInfoBodyEnrollmentStatus];


export const EditUserInfoBodyEnrollmentStatus = {
  ENROLLED: 'ENROLLED',
