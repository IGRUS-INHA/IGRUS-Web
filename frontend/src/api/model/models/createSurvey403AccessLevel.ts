...
export type CreateSurvey403AccessLevel = typeof CreateSurvey403AccessLevel[keyof typeof CreateSurvey403AccessLevel];


export const CreateSurvey403AccessLevel = {
  PUBLIC: 'PUBLIC',
  ASSOCIATE: 'ASSOCIATE',
  MEMBER: 'MEMBER',
  OPERATOR: 'OPERATOR',
