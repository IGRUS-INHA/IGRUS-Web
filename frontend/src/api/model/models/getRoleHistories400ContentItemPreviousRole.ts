 ...
 * 변경 전 역할
 */
export type GetRoleHistories400ContentItemPreviousRole = typeof GetRoleHistories400ContentItemPreviousRole[keyof typeof GetRoleHistories400ContentItemPreviousRole];


export const GetRoleHistories400ContentItemPreviousRole = {
  ASSOCIATE: 'ASSOCIATE',
  MEMBER: 'MEMBER',
  OPERATOR: 'OPERATOR',
  ADMIN: 'ADMIN',
