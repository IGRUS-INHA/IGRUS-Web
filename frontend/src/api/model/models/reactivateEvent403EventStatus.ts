...
export type ReactivateEvent403EventStatus = typeof ReactivateEvent403EventStatus[keyof typeof ReactivateEvent403EventStatus];


export const ReactivateEvent403EventStatus = {
  UPCOMING: 'UPCOMING',
  ONGOING: 'ONGOING',
  COMPLETED: 'COMPLETED',
  CANCELED: 'CANCELED',
