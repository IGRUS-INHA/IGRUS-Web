...
export type QuestionResponseQuestionType = typeof QuestionResponseQuestionType[keyof typeof QuestionResponseQuestionType];


export const QuestionResponseQuestionType = {
