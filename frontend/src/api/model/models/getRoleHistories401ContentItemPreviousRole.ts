 ...
 * 변경 전 역할
 */
export type GetRoleHistories401ContentItemPreviousRole = typeof GetRoleHistories401ContentItemPreviousRole[keyof typeof GetRoleHistories401ContentItemPreviousRole];


export const GetRoleHistories401ContentItemPreviousRole = {
  ASSOCIATE: 'ASSOCIATE',
  MEMBER: 'MEMBER',
  OPERATOR: 'OPERATOR',
  ADMIN: 'ADMIN',
