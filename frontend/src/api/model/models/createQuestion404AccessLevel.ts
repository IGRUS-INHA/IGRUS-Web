...
export type CreateQuestion404AccessLevel = typeof CreateQuestion404AccessLevel[keyof typeof CreateQuestion404AccessLevel];


export const CreateQuestion404AccessLevel = {
  PUBLIC: 'PUBLIC',
  ASSOCIATE: 'ASSOCIATE',
  MEMBER: 'MEMBER',
  OPERATOR: 'OPERATOR',
