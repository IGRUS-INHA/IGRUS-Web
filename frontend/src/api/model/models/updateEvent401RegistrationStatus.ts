...
export type UpdateEvent401RegistrationStatus = typeof UpdateEvent401RegistrationStatus[keyof typeof UpdateEvent401RegistrationStatus];


export const UpdateEvent401RegistrationStatus = {
