...
export type GetEventListRegistrationStatus = typeof GetEventListRegistrationStatus[keyof typeof GetEventListRegistrationStatus];


export const GetEventListRegistrationStatus = {
