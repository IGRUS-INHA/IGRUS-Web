...
export type GetSurveyDetail403AccessLevel = typeof GetSurveyDetail403AccessLevel[keyof typeof GetSurveyDetail403AccessLevel];


export const GetSurveyDetail403AccessLevel = {
  PUBLIC: 'PUBLIC',
  ASSOCIATE: 'ASSOCIATE',
  MEMBER: 'MEMBER',
  OPERATOR: 'OPERATOR',
