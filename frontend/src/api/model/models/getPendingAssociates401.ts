 ...
 */
import type { GetPendingAssociates401AssociatesItem } from './getPendingAssociates401AssociatesItem';

/**
 * 준회원 목록 페이징 응답
 */
export type GetPendingAssociates401 = {
  /** 준회원 목록 */
  associates?: GetPendingAssociates401AssociatesItem[];
  /** 전체 요소 수 */
