...
export type UpdateSurvey401AccessLevel = typeof UpdateSurvey401AccessLevel[keyof typeof UpdateSurvey401AccessLevel];


export const UpdateSurvey401AccessLevel = {
  PUBLIC: 'PUBLIC',
  ASSOCIATE: 'ASSOCIATE',
  MEMBER: 'MEMBER',
  OPERATOR: 'OPERATOR',
