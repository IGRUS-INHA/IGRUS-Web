 ...
 */
import type { GetMyRegistrations1200ItemStatus } from './getMyRegistrations1200ItemStatus';

export type GetMyRegistrations1200Item = {
  registrationId?: number;
  eventId?: number;
  eventTitle?: string;
  eventStartAt?: string;
  status?: GetMyRegistrations1200ItemStatus;
  registeredAt?: string;
};
