 ...
 */
import type { GetDemotedAssociates403PageableSort } from './getDemotedAssociates403PageableSort';

export type GetDemotedAssociates403Pageable = {
  paged?: boolean;
  pageNumber?: number;
  pageSize?: number;
  offset?: number;
  sort?: GetDemotedAssociates403PageableSort;
  unpaged?: boolean;
};
