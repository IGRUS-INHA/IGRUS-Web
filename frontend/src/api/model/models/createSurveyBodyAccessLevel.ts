...
export type CreateSurveyBodyAccessLevel = typeof CreateSurveyBodyAccessLevel[keyof typeof CreateSurveyBodyAccessLevel];


export const CreateSurveyBodyAccessLevel = {
  PUBLIC: 'PUBLIC',
  ASSOCIATE: 'ASSOCIATE',
  MEMBER: 'MEMBER',
  OPERATOR: 'OPERATOR',
