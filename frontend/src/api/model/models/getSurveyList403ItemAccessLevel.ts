...
export type GetSurveyList403ItemAccessLevel = typeof GetSurveyList403ItemAccessLevel[keyof typeof GetSurveyList403ItemAccessLevel];


export const GetSurveyList403ItemAccessLevel = {
  PUBLIC: 'PUBLIC',
  ASSOCIATE: 'ASSOCIATE',
  MEMBER: 'MEMBER',
  OPERATOR: 'OPERATOR',
