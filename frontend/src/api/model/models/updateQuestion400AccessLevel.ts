...
export type UpdateQuestion400AccessLevel = typeof UpdateQuestion400AccessLevel[keyof typeof UpdateQuestion400AccessLevel];


export const UpdateQuestion400AccessLevel = {
  PUBLIC: 'PUBLIC',
  ASSOCIATE: 'ASSOCIATE',
  MEMBER: 'MEMBER',
  OPERATOR: 'OPERATOR',
