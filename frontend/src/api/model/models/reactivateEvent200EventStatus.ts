...
export type ReactivateEvent200EventStatus = typeof ReactivateEvent200EventStatus[keyof typeof ReactivateEvent200EventStatus];


export const ReactivateEvent200EventStatus = {
  UPCOMING: 'UPCOMING',
  ONGOING: 'ONGOING',
  COMPLETED: 'COMPLETED',
  CANCELED: 'CANCELED',
