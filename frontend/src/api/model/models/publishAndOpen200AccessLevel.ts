...
export type PublishAndOpen200AccessLevel = typeof PublishAndOpen200AccessLevel[keyof typeof PublishAndOpen200AccessLevel];


export const PublishAndOpen200AccessLevel = {
  PUBLIC: 'PUBLIC',
  ASSOCIATE: 'ASSOCIATE',
  MEMBER: 'MEMBER',
  OPERATOR: 'OPERATOR',
