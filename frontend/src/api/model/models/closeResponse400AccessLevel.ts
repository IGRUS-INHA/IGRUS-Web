...
export type CloseResponse400AccessLevel = typeof CloseResponse400AccessLevel[keyof typeof CloseResponse400AccessLevel];


export const CloseResponse400AccessLevel = {
  PUBLIC: 'PUBLIC',
  ASSOCIATE: 'ASSOCIATE',
  MEMBER: 'MEMBER',
  OPERATOR: 'OPERATOR',
