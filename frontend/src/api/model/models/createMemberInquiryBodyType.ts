 ...
 * 문의 유형
 */
export type CreateMemberInquiryBodyType = typeof CreateMemberInquiryBodyType[keyof typeof CreateMemberInquiryBodyType];


export const CreateMemberInquiryBodyType = {
  JOIN: 'JOIN',
  EVENT: 'EVENT',
  REPORT: 'REPORT',
  ACCOUNT: 'ACCOUNT',
