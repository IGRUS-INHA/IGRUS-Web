...
export type CancelRegistration401Status = typeof CancelRegistration401Status[keyof typeof CancelRegistration401Status];


export const CancelRegistration401Status = {
