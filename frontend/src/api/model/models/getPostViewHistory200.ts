 ...
 */
import type { GetPostViewHistory200ViewHistoryItem } from './getPostViewHistory200ViewHistoryItem';

/**
 * 게시글 조회 기록 페이징 응답
 */
export type GetPostViewHistory200 = {
  /** 조회 기록 목록 */
  viewHistory?: GetPostViewHistory200ViewHistoryItem[];
  /** 전체 요소 수 */
