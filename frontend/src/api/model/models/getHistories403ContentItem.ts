 ...
 */
import type { GetHistories403ContentItemChangeType } from './getHistories403ContentItemChangeType';

/**
 * 계정 상태 변경 감사 이력 응답
 */
export type GetHistories403ContentItem = {
  /** 이력 ID */
  id?: number;
  /** 대상 사용자 ID */
  userId?: number;
  ...
  /** 변경 유형 */
  changeType?: GetHistories403ContentItemChangeType;
  /** 변경 전 값 */
