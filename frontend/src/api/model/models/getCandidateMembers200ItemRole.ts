 ...
 * 현재 역할
 */
export type GetCandidateMembers200ItemRole = typeof GetCandidateMembers200ItemRole[keyof typeof GetCandidateMembers200ItemRole];


export const GetCandidateMembers200ItemRole = {
  ASSOCIATE: 'ASSOCIATE',
  MEMBER: 'MEMBER',
  OPERATOR: 'OPERATOR',
  ADMIN: 'ADMIN',
