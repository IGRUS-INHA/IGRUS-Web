 ...
 * 역할
 */
export type GetUserList200UsersItemRole = typeof GetUserList200UsersItemRole[keyof typeof GetUserList200UsersItemRole];


export const GetUserList200UsersItemRole = {
  ASSOCIATE: 'ASSOCIATE',
  MEMBER: 'MEMBER',
  OPERATOR: 'OPERATOR',
  ADMIN: 'ADMIN',
