 ...
 */
import type { GetPendingReports401ItemStatus } from './getPendingReports401ItemStatus';

export type GetPendingReports401Item = {
  id?: number;
  commentId?: number;
  ...
  reporterName?: string;
  reason?: string;
  status?: GetPendingReports401ItemStatus;
  createdAt?: string;
  resolvedAt?: string;
  resolvedById?: number;
