 ...
 */
import type { GetAllInquiries401InquiriesItemStatus } from './getAllInquiries401InquiriesItemStatus';
import type { GetAllInquiries401InquiriesItemType } from './getAllInquiries401InquiriesItemType';

/**
 * 문의 목록 응답
 */
export type GetAllInquiries401InquiriesItem = {
  /** 문의 고유 ID */
  id?: number;
  /** 문의 번호 */
  inquiryNumber?: string;
  /** 문의 유형 */
  type?: GetAllInquiries401InquiriesItemType;
  /** 문의 유형 설명 */
  typeDescription?: string;
  /** 문의 상태 */
  status?: GetAllInquiries401InquiriesItemStatus;
  /** 문의 상태 설명 */
