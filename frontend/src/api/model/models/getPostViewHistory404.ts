 ...
 */
import type { GetPostViewHistory404ViewHistoryItem } from './getPostViewHistory404ViewHistoryItem';

/**
 * 게시글 조회 기록 페이징 응답
 */
export type GetPostViewHistory404 = {
  /** 조회 기록 목록 */
  viewHistory?: GetPostViewHistory404ViewHistoryItem[];
  /** 전체 요소 수 */
