 ...
 */
import type { GetPostViewHistory401ViewHistoryItem } from './getPostViewHistory401ViewHistoryItem';

/**
 * 게시글 조회 기록 페이징 응답
 */
export type GetPostViewHistory401 = {
  /** 조회 기록 목록 */
  viewHistory?: GetPostViewHistory401ViewHistoryItem[];
  /** 전체 요소 수 */
