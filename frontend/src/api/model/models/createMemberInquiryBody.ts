 ...
 */
import type { CreateMemberInquiryBodyAttachmentsItem } from './createMemberInquiryBodyAttachmentsItem';
import type { CreateMemberInquiryBodyType } from './createMemberInquiryBodyType';

/**
 * 회원 문의 생성 요청
 */
export type CreateMemberInquiryBody = {
  /** 문의 유형 */
  type: CreateMemberInquiryBodyType;
  /**
   * 문의 제목 (100자 이내)
   * @minLength 0
   * @maxLength 100
   ...
   * @maxItems 3
   */
  attachments?: CreateMemberInquiryBodyAttachmentsItem[];
};
