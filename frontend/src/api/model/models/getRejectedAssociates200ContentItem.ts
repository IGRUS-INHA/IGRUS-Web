 ...
 */
import type { GetRejectedAssociates200ContentItemWishesItem } from './getRejectedAssociates200ContentItemWishesItem';

/**
 * 거절된 준회원 정보 응답
 */
export type GetRejectedAssociates200ContentItem = {
  /** 사용자 고유 ID */
  userId?: number;
  /** 학번 */
  studentId?: string;
  ...
  motivation?: string;
  /** 가입 목적 */
  wishes?: GetRejectedAssociates200ContentItemWishesItem[];
  /** 가입 신청 일시 */
  createdAt?: string;
  /** 거절 사유 */
