 ...
 */
import type { GetRoleHistories403ContentItemNewRole } from './getRoleHistories403ContentItemNewRole';
import type { GetRoleHistories403ContentItemPreviousRole } from './getRoleHistories403ContentItemPreviousRole';

/**
 * 권한 변경 이력 응답
 */
export type GetRoleHistories403ContentItem = {
  /** 이력 ID */
  id?: number;
  /** 대상 사용자 ID */
  userId?: number;
  ...
  studentId?: string;
  /** 변경 전 역할 */
  previousRole?: GetRoleHistories403ContentItemPreviousRole;
  /** 변경 후 역할 */
  newRole?: GetRoleHistories403ContentItemNewRole;
  /** 변경 사유 */
  reason?: string;
  /** 변경자 ID */
  changedBy?: number;
