 ...
 * 사용자 권한
 */
export type AccountRecoveryResponseRole = typeof AccountRecoveryResponseRole[keyof typeof AccountRecoveryResponseRole];


export const AccountRecoveryResponseRole = {
  ASSOCIATE: 'ASSOCIATE',
  MEMBER: 'MEMBER',
  OPERATOR: 'OPERATOR',
  ADMIN: 'ADMIN',
