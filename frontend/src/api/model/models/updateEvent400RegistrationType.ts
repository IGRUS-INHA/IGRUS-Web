...
export type UpdateEvent400RegistrationType = typeof UpdateEvent400RegistrationType[keyof typeof UpdateEvent400RegistrationType];


export const UpdateEvent400RegistrationType = {
