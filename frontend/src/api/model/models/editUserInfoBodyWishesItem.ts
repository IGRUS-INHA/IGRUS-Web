...
export type EditUserInfoBodyWishesItem = typeof EditUserInfoBodyWishesItem[keyof typeof EditUserInfoBodyWishesItem];


export const EditUserInfoBodyWishesItem = {
