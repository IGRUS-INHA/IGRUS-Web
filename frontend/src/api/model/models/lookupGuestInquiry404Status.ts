 ...
 * 문의 상태
 */
export type LookupGuestInquiry404Status = typeof LookupGuestInquiry404Status[keyof typeof LookupGuestInquiry404Status];


export const LookupGuestInquiry404Status = {
  PENDING: 'PENDING',
