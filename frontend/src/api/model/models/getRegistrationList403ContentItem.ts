 ...
 */
import type { GetRegistrationList403ContentItemStatus } from './getRegistrationList403ContentItemStatus';

export type GetRegistrationList403ContentItem = {
  ...
  status?: GetRegistrationList403ContentItemStatus;
  registeredAt?: string;
};
