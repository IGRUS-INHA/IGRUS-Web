 ...
 */
import type { SubmitAnonymousResponse404AnswersItem } from './submitAnonymousResponse404AnswersItem';

export type SubmitAnonymousResponse404 = {
  responseId?: number;
  surveyId?: number;
  userId?: number;
  answers?: SubmitAnonymousResponse404AnswersItem[];
  createdAt?: string;
};
