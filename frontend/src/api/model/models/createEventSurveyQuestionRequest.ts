 ...
 */
import type { CreateEventSurveyQuestionRequestQuestionType } from "./createEventSurveyQuestionRequestQuestionType";

/**
 * 행사 설문 질문 정보
 */
export interface CreateEventSurveyQuestionRequest {
  /** 질문 유형 */
  questionType: CreateEventSurveyQuestionRequestQuestionType;
  /**
   * 질문 제목
   * @minLength 1
   * @maxLength 200
  ...
  displayOrder?: number;
  /**
   * 선택지 목록 (MULTIPLE_CHOICE, CHECKBOX, DROPDOWN에서 사용)
   * @nullable
   */
  options?: string[] | null;
}
