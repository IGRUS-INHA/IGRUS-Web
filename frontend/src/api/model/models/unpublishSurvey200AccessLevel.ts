...
export type UnpublishSurvey200AccessLevel = typeof UnpublishSurvey200AccessLevel[keyof typeof UnpublishSurvey200AccessLevel];


export const UnpublishSurvey200AccessLevel = {
  PUBLIC: 'PUBLIC',
  ASSOCIATE: 'ASSOCIATE',
  MEMBER: 'MEMBER',
  OPERATOR: 'OPERATOR',
