 ...
 * 변경 유형
 */
export type GetHistories403ContentItemChangeType = typeof GetHistories403ContentItemChangeType[keyof typeof GetHistories403ContentItemChangeType];


export const GetHistories403ContentItemChangeType = {
