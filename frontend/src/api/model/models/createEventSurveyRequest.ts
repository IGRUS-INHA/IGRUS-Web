 ...
 */
import type { CreateEventSurveyQuestionRequest } from "./createEventSurveyQuestionRequest";

/**
 * 행사와 함께 생성할 설문 정보
 */
export interface CreateEventSurveyRequest {
  /**
   * 설문 제목
   * @minLength 1
   * @maxLength 100
   ...
   * @maxItems 50
   */
  questions: CreateEventSurveyQuestionRequest[];
}
