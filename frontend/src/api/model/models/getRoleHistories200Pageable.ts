 ...
 */
import type { GetRoleHistories200PageableSort } from './getRoleHistories200PageableSort';

export type GetRoleHistories200Pageable = {
  paged?: boolean;
  pageNumber?: number;
  pageSize?: number;
  offset?: number;
  sort?: GetRoleHistories200PageableSort;
  unpaged?: boolean;
};
