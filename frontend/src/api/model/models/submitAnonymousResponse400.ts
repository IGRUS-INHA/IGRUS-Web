 ...
 */
import type { SubmitAnonymousResponse400AnswersItem } from './submitAnonymousResponse400AnswersItem';

export type SubmitAnonymousResponse400 = {
  responseId?: number;
  surveyId?: number;
  userId?: number;
  answers?: SubmitAnonymousResponse400AnswersItem[];
  createdAt?: string;
};
