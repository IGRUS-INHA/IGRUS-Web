 ...
 * 문의 유형
 */
export type GetMyInquiries401InquiriesItemType = typeof GetMyInquiries401InquiriesItemType[keyof typeof GetMyInquiries401InquiriesItemType];


export const GetMyInquiries401InquiriesItemType = {
  JOIN: 'JOIN',
  EVENT: 'EVENT',
  REPORT: 'REPORT',
  ACCOUNT: 'ACCOUNT',
