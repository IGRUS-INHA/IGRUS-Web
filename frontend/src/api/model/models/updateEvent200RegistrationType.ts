...
export type UpdateEvent200RegistrationType = typeof UpdateEvent200RegistrationType[keyof typeof UpdateEvent200RegistrationType];


export const UpdateEvent200RegistrationType = {
