...
export type PublishAndOpen404AccessLevel = typeof PublishAndOpen404AccessLevel[keyof typeof PublishAndOpen404AccessLevel];


export const PublishAndOpen404AccessLevel = {
  PUBLIC: 'PUBLIC',
  ASSOCIATE: 'ASSOCIATE',
  MEMBER: 'MEMBER',
  OPERATOR: 'OPERATOR',
