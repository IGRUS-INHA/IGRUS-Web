...
export type UnpublishSurvey400AccessLevel = typeof UnpublishSurvey400AccessLevel[keyof typeof UnpublishSurvey400AccessLevel];


export const UnpublishSurvey400AccessLevel = {
  PUBLIC: 'PUBLIC',
  ASSOCIATE: 'ASSOCIATE',
  MEMBER: 'MEMBER',
  OPERATOR: 'OPERATOR',
