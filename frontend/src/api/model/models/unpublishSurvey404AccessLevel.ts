...
export type UnpublishSurvey404AccessLevel = typeof UnpublishSurvey404AccessLevel[keyof typeof UnpublishSurvey404AccessLevel];


export const UnpublishSurvey404AccessLevel = {
  PUBLIC: 'PUBLIC',
  ASSOCIATE: 'ASSOCIATE',
  MEMBER: 'MEMBER',
  OPERATOR: 'OPERATOR',
