...
export type PublishAndOpen403AccessLevel = typeof PublishAndOpen403AccessLevel[keyof typeof PublishAndOpen403AccessLevel];


export const PublishAndOpen403AccessLevel = {
  PUBLIC: 'PUBLIC',
  ASSOCIATE: 'ASSOCIATE',
  MEMBER: 'MEMBER',
  OPERATOR: 'OPERATOR',
