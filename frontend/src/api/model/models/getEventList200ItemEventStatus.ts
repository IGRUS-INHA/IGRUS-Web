...
export type GetEventList200ItemEventStatus = typeof GetEventList200ItemEventStatus[keyof typeof GetEventList200ItemEventStatus];


export const GetEventList200ItemEventStatus = {
  UPCOMING: 'UPCOMING',
  ONGOING: 'ONGOING',
  COMPLETED: 'COMPLETED',
  CANCELED: 'CANCELED',
