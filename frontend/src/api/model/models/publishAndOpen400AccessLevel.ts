...
export type PublishAndOpen400AccessLevel = typeof PublishAndOpen400AccessLevel[keyof typeof PublishAndOpen400AccessLevel];


export const PublishAndOpen400AccessLevel = {
  PUBLIC: 'PUBLIC',
  ASSOCIATE: 'ASSOCIATE',
  MEMBER: 'MEMBER',
  OPERATOR: 'OPERATOR',
