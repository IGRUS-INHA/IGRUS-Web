...
export type GetTrashedSurveyList401ItemAccessLevel = typeof GetTrashedSurveyList401ItemAccessLevel[keyof typeof GetTrashedSurveyList401ItemAccessLevel];


export const GetTrashedSurveyList401ItemAccessLevel = {
  PUBLIC: 'PUBLIC',
  ASSOCIATE: 'ASSOCIATE',
  MEMBER: 'MEMBER',
  OPERATOR: 'OPERATOR',
