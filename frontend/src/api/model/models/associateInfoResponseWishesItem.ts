...
export type AssociateInfoResponseWishesItem = typeof AssociateInfoResponseWishesItem[keyof typeof AssociateInfoResponseWishesItem];


export const AssociateInfoResponseWishesItem = {
