 ...
 */
import type { GetAllInquiries200InquiriesItem } from './getAllInquiries200InquiriesItem';

/**
 * 문의 목록 페이징 응답
 */
export type GetAllInquiries200 = {
  /** 문의 목록 */
  inquiries?: GetAllInquiries200InquiriesItem[];
  /** 전체 요소 수 */
