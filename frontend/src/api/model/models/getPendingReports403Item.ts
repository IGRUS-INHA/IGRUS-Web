 ...
 */
import type { GetPendingReports403ItemStatus } from './getPendingReports403ItemStatus';

export type GetPendingReports403Item = {
  id?: number;
  commentId?: number;
  ...
  reporterName?: string;
  reason?: string;
  status?: GetPendingReports403ItemStatus;
  createdAt?: string;
  resolvedAt?: string;
  resolvedById?: number;
