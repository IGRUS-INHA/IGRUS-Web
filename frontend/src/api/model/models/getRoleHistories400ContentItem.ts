 ...
 */
import type { GetRoleHistories400ContentItemNewRole } from './getRoleHistories400ContentItemNewRole';
import type { GetRoleHistories400ContentItemPreviousRole } from './getRoleHistories400ContentItemPreviousRole';

/**
 * 권한 변경 이력 응답
 */
export type GetRoleHistories400ContentItem = {
  /** 이력 ID */
  id?: number;
  /** 대상 사용자 ID */
  userId?: number;
  ...
  studentId?: string;
  /** 변경 전 역할 */
  previousRole?: GetRoleHistories400ContentItemPreviousRole;
  /** 변경 후 역할 */
  newRole?: GetRoleHistories400ContentItemNewRole;
  /** 변경 사유 */
  reason?: string;
  /** 변경자 ID */
  changedBy?: number;
