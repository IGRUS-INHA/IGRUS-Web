...
export type RevertRegistration403Status = typeof RevertRegistration403Status[keyof typeof RevertRegistration403Status];


export const RevertRegistration403Status = {
