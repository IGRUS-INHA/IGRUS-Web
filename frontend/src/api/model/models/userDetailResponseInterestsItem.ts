...
export type UserDetailResponseInterestsItem = typeof UserDetailResponseInterestsItem[keyof typeof UserDetailResponseInterestsItem];


export const UserDetailResponseInterestsItem = {
