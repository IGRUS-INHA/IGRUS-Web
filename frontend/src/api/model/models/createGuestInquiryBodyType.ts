 ...
 * 문의 유형
 */
export type CreateGuestInquiryBodyType = typeof CreateGuestInquiryBodyType[keyof typeof CreateGuestInquiryBodyType];


export const CreateGuestInquiryBodyType = {
  JOIN: 'JOIN',
  EVENT: 'EVENT',
  REPORT: 'REPORT',
  ACCOUNT: 'ACCOUNT',
