...
export type GetSurveyList200ItemAccessLevel = typeof GetSurveyList200ItemAccessLevel[keyof typeof GetSurveyList200ItemAccessLevel];


export const GetSurveyList200ItemAccessLevel = {
  PUBLIC: 'PUBLIC',
  ASSOCIATE: 'ASSOCIATE',
  MEMBER: 'MEMBER',
  OPERATOR: 'OPERATOR',
